...
public class HugeTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
    public HugeTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225820_1_) {
        super(p_i225820_1_);
    }
