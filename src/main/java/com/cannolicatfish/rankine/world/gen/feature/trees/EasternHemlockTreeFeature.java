            ...
            if (i > 1) {
                if (i%2==0) {
                    ...
                    if (i > crownHeight * 0.70) {
                        WorldgenUtils.placeLogAt(reader,pos.down(i).north(3),rand,config,Direction.Axis.Z);
                        hemlockLeaves(reader, pos.down(i).north(3), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).north(2).east(),rand,config,Direction.Axis.X);
                        hemlockLeaves(reader, pos.down(i).north(2).east(), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).north(2).west(),rand,config,Direction.Axis.X);
                        hemlockLeaves(reader, pos.down(i).north(2).west(), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).south(3),rand,config,Direction.Axis.Z);
                        hemlockLeaves(reader, pos.down(i).south(3), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).south(2).east(),rand,config,Direction.Axis.X);
                        hemlockLeaves(reader, pos.down(i).south(2).east(), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).south(2).west(),rand,config,Direction.Axis.X);
                        hemlockLeaves(reader, pos.down(i).south(2).west(), rand, config);
                    }
                } else {
                    ...
                    if (i > crownHeight * 0.70) {
                        WorldgenUtils.placeLogAt(reader,pos.down(i).east(3),rand,config,Direction.Axis.X);
                        hemlockLeaves(reader, pos.down(i).east(3), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).east(2).north(),rand,config,Direction.Axis.Z);
                        hemlockLeaves(reader, pos.down(i).east(2).north(), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).east(2).south(),rand,config,Direction.Axis.Z);
                        hemlockLeaves(reader, pos.down(i).east(2).south(), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).west(3),rand,config,Direction.Axis.X);
                        hemlockLeaves(reader, pos.down(i).west(3), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).west(2).north(),rand,config,Direction.Axis.Z);
                        hemlockLeaves(reader, pos.down(i).west(2).north(), rand, config);
                        WorldgenUtils.placeLogAt(reader,pos.down(i).west(2).south(),rand,config,Direction.Axis.Z);
                        hemlockLeaves(reader, pos.down(i).west(2).south(), rand, config);
                    }
                }
            }
