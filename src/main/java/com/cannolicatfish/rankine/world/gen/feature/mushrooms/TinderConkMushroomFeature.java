...
public class TinderConkMushroomFeature extends Feature<BlockStateProvidingFeatureConfig> {
    ...
    public TinderConkMushroomFeature(Codec<BlockStateProvidingFeatureConfig> configFactoryIn) {
    ...
    public static boolean growMushroom(ISeedReader reader, Random rand, BlockPos pos, BlockStateProvidingFeatureConfig config, Direction dir) {
        ...
        if (flag) {
            ...
            reader.setBlock(pos.relative(dir).relative(dir.getClockWise()), state, 3);
            ...
            reader.setBlock(pos.relative(dir).relative(dir.getCounterClockWise()), state, 3);
            return true;
        }
        return false;
    }
