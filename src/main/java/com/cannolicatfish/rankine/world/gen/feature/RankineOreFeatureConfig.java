    ...
    public static enum RankineFillerBlockType implements IStringSerializable, net.minecraftforge.common.IExtensibleEnum {
        ...
        IGNEOUS("igneous", (blockstate) -> {
            if (blockstate == null) {
                ...
                Block block = blockstate.getBlock();
                return block == Blocks.GRANITE || block == Blocks.DIORITE || block == Blocks.ANDESITE || block == ModBlocks.RED_GRANITE || block == ModBlocks.HORNBLENDE_ANDESITE || block == ModBlocks.GRANODIORITE || block == ModBlocks.BLACK_DACITE || block == ModBlocks.RED_DACITE || block == ModBlocks.ANORTHOSITE || block == ModBlocks.THOLEIITIC_BASALT || block == ModBlocks.RHYOLITE || block == ModBlocks.GABBRO;
            }
        }),
        SEDIMENTARY("sedimentary", (blockstate) -> {
            if (blockstate == null) {
                ...
                Block block = blockstate.getBlock();
                return block == Blocks.SANDSTONE || block == Blocks.RED_SANDSTONE || block == ModBlocks.LIMESTONE || block == ModBlocks.ARKOSE_SANDSTONE || block == ModBlocks.QUARTZ_SANDSTONE|| block == ModBlocks.SHALE || block == ModBlocks.BRECCIA || block == ModBlocks.MUDSTONE || block == ModBlocks.CHALK;
            }
        }),
        METAMORPHIC("metamorphic", (blockstate) -> {
            if (blockstate == null) {
                ...
                Block block = blockstate.getBlock();
                return block == ModBlocks.MARBLE || block == ModBlocks.GNEISS || block == ModBlocks.SLATE || block == ModBlocks.SCHIST;
            }
        }),
