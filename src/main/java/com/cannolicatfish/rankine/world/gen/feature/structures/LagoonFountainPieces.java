...
public class LagoonFountainPieces
{
    /*
     ...
     */
    private static final ResourceLocation LEFT_SIDE = new ResourceLocation(ProjectRankine.MODID + ":lagoon_fountain");
//    private static final ResourceLocation RIGHT_SIDE = new ResourceLocation(ProjectRankine.MODID + ":beaver_lodge_right");
    private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(LEFT_SIDE, new BlockPos(0, 0, 0));
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random)
    {
        ...
        pieceList.add(new LagoonFountainPieces.Piece(templateManager, LEFT_SIDE, blockpos, rotation));
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        {
            super(RankineFeatures.LAGOON_FOUNTAIN_PIECE, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = LagoonFountainPieces.OFFSET.get(resourceLocation);
        ...
        {
            super(RankineFeatures.LAGOON_FOUNTAIN_PIECE, tagCompound);
        ...
        @Override
        public boolean func_230383_a_(ISeedReader worldIn, StructureManager structureManagerIn, ChunkGenerator chunkGeneratorIn, Random random, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos, BlockPos pos)
        {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
            BlockPos blockpos = LagoonFountainPieces.OFFSET.get(this.resourceLocation);
            this.templatePosition.add(Template.transformedBlockPos(placementsettings, new BlockPos(0 - blockpos.getX(), 0, 0 - blockpos.getZ())));

            return super.func_230383_a_(worldIn, structureManagerIn, chunkGeneratorIn, random, structureBoundingBoxIn, chunkPos, pos);
        }
    }
