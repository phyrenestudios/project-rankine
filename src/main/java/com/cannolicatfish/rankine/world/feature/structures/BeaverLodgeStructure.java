package com.cannolicatfish.rankine.world.feature.structures;
...
public class BeaverLodgeStructure extends Structure<NoFeatureConfig>
{
    ...
    private static final List<Biome.SpawnListEntry> BEAVER_LODGE_MOBS = Lists.newArrayList(new Biome.SpawnListEntry(ModEntityTypes.BEAVER, 10, 2, 3));
