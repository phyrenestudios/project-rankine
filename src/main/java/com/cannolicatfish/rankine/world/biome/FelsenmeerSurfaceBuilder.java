                    ...
                    if (l == -1) {
                        ...
                        if (j1 >= seaLevel - 1) {
                            if (j1 > 86 + k * 2) {
                                ...
                                if (ran <= .2f)
                                {
                                    chunkIn.setBlockState(blockpos$mutable, GRASS_BLOCK, false);
                                } else if (ran <= .6f)
                                {
                                ...
                                {
                                    chunkIn.setBlockState(blockpos$mutable, Blocks.COBBLESTONE.getDefaultState(), false);
                                }
                            ...
                            if (blockstate1 == DIRT) {
                                chunkIn.setBlockState(blockpos$mutable, DIRT, false);
                            }
                        }
                    } else if (l > 0) {
                        --l;
    ...
    protected void func_215430_b(long p_215430_1_) {
        ...
        for(int k2 = 0; k2 < j2; ++k2) {
            ...
            for(int i1 = 0; l3 + i1 < 64 && i1 < i3; ++i1) {
                this.field_215432_a[l3 + i1] = DIRT;
            }
        }
        ...
        for(int j3 = 0; j3 < l2; ++j3) {
            ...
            for(int j1 = 0; k4 + j1 < 64 && j1 < i4; ++j1) {
                this.field_215432_a[k4 + j1] = DIRT;
            }
        }
        ...
        for(int l4 = 0; l4 < k3; ++l4) {
            ...
            for(int k1 = 0; j4 + k1 < 64 && k1 < 1; ++k1) {
                this.field_215432_a[j4 + k1] = DIRT;
                if (j4 + k1 > 1 && sharedseedrandom.nextBoolean()) {
                    this.field_215432_a[j4 + k1 - 1] = DIRT;
                }
