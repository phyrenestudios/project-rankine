...
public class ShoalBiome extends Biome {
    public ShoalBiome() {
        super((new Builder()).surfaceBuilder(SurfaceBuilder.SWAMP, SurfaceBuilder.SAND_SAND_GRAVEL_CONFIG).precipitation(RainType.RAIN).category(Category.OCEAN).depth(-0.25F).scale(0.1F).temperature(0.7F).downfall(0.5F).waterColor(4159204).waterFogColor(329011).parent((String)null));
        ...
        ModBiomeFeatures.addCoconutPalmTrees(this);
