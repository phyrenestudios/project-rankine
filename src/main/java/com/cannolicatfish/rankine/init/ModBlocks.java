...
//-------------------------------------
    ...
    public static final Block RED_GRANITE = add("red_granite", new RankineStone(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_RED_GRANITE = add("polished_red_granite", new Block(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block RED_GRANITE_BRICKS = add("red_granite_bricks", new Block(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block GRANODIORITE = add("granodiorite", new RankineStone(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_GRANODIORITE = add("polished_granodiorite", new Block(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block GRANODIORITE_BRICKS = add("granodiorite_bricks", new Block(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block THOLEIITIC_BASALT = add("tholeiitic_basalt", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_THOLEIITIC_BASALT = add("polished_tholeiitic_basalt", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_BRICKS = add("tholeiitic_basalt_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO = add("gabbro", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GABBRO = add("polished_gabbro", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_BRICKS = add("gabbro_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block RHYOLITE = add("rhyolite", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_RHYOLITE = add("polished_rhyolite", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block RHYOLITE_BRICKS = add("rhyolite_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block MARBLE = add("marble", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_MARBLE = add("polished_marble", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block MARBLE_BRICKS = add("marble_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS = add("gneiss", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GNEISS = add("polished_gneiss", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_BRICKS = add("gneiss_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST = add("schist", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SCHIST = add("polished_schist", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_BRICKS = add("schist_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE = add("slate", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SLATE = add("polished_slate", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_BRICKS = add("slate_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block BRECCIA = add("breccia", new RankineStone(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_BRECCIA = add("polished_breccia", new Block(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block BRECCIA_BRICKS = add("breccia_bricks", new Block(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block PUMICE = add("pumice", new RankineStone(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_PUMICE = add("polished_pumice", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_SCORIA = add("polished_scoria", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCORIA_BRICKS = add("scoria_bricks", new Block(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block PERIDOTITE = add("peridotite", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PERIDOTITE = add("polished_peridotite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PERIDOTITE_BRICKS = add("peridotite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE = add("kimberlite", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KIMBERLITE = add("polished_kimberlite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_BRICKS = add("kimberlite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE = add("komatiite", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KOMATIITE = add("polished_komatiite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_BRICKS = add("komatiite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE = add("ringwoodite", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_RINGWOODITE = add("polished_ringwoodite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_BRICKS = add("ringwoodite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE = add("wadsleyite",new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_WADSLEYITE = add("polished_wadsleyite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_BRICKS = add("wadsleyite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE = add("bridgmanite", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_BRIDGMANITE = add("polished_bridgmanite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_BRICKS = add("bridgmanite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE = add("ferropericlase", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_FERROPERICLASE = add("polished_ferropericlase", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_BRICKS = add("ferropericlase_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE = add("perovskite", new RankineStone(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PEROVSKITE = add("polished_perovskite", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_BRICKS = add("perovskite_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block ZIRCON_REFRACTORY_BRICKS = add("zircon_refractory_bricks", new Block(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block RED_GRANITE_SLAB = add("red_granite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_RED_GRANITE_SLAB = add("polished_red_granite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block GRANODIORITE_SLAB = add("granodiorite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_GRANODIORITE_SLAB = add("polished_granodiorite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block GRANODIORITE_BRICKS_SLAB = add("granodiorite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_SLAB = add("hornblende_andesite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_HORNBLENDE_ANDESITE_SLAB = add("polished_hornblende_andesite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_BRICKS_SLAB = add("hornblende_andesite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_SLAB = add("tholeiitic_basalt_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_THOLEIITIC_BASALT_SLAB = add("polished_tholeiitic_basalt_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_BRICKS_SLAB = add("tholeiitic_basalt_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_SLAB = add("gabbro_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GABBRO_SLAB = add("polished_gabbro_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_BRICKS_SLAB = add("gabbro_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block ANORTHOSITE_SLAB = add("anorthosite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_ANORTHOSITE_SLAB = add("polished_anorthosite_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block RHYOLITE_SLAB = add("rhyolite_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_RHYOLITE_SLAB = add("polished_rhyolite_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block RHYOLITE_BRICKS_SLAB = add("rhyolite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block LIMESTONE_SLAB = add("limestone_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_LIMESTONE_SLAB = add("polished_limestone_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block MARBLE_SLAB = add("marble_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_MARBLE_SLAB = add("polished_marble_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block MARBLE_BRICKS_SLAB = add("marble_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_SLAB = add("gneiss_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GNEISS_SLAB = add("polished_gneiss_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_BRICKS_SLAB = add("gneiss_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_SLAB = add("schist_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SCHIST_SLAB = add("polished_schist_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_BRICKS_SLAB = add("schist_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_SLAB = add("slate_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SLATE_SLAB = add("polished_slate_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_BRICKS_SLAB = add("slate_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SHALE_SLAB = add("shale_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_SHALE_SLAB = add("polished_shale_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_IRONSTONE_SLAB = add("polished_ironstone_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block BRECCIA_SLAB = add("breccia_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_BRECCIA_SLAB = add("polished_breccia_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block BRECCIA_BRICKS_SLAB = add("breccia_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block PUMICE_SLAB = add("pumice_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_PUMICE_SLAB = add("polished_pumice_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_SCORIA_SLAB = add("polished_scoria_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCORIA_BRICKS_SLAB = add("scoria_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block PERIDOTITE_SLAB = add("peridotite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PERIDOTITE_SLAB = add("polished_peridotite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PERIDOTITE_BRICKS_SLAB = add("peridotite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_SLAB = add("kimberlite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KIMBERLITE_SLAB = add("polished_kimberlite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_BRICKS_SLAB = add("kimberlite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_SLAB = add("komatiite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KOMATIITE_SLAB = add("polished_komatiite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_BRICKS_SLAB = add("komatiite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_SLAB = add("ringwoodite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_RINGWOODITE_SLAB = add("polished_ringwoodite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_BRICKS_SLAB = add("ringwoodite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_SLAB = add("wadsleyite_slab",new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_WADSLEYITE_SLAB = add("polished_wadsleyite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_BRICKS_SLAB = add("wadsleyite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_SLAB = add("bridgmanite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_BRIDGMANITE_SLAB = add("polished_bridgmanite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_BRICKS_SLAB = add("bridgmanite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_SLAB = add("ferropericlase_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_FERROPERICLASE_SLAB = add("polished_ferropericlase_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_BRICKS_SLAB = add("ferropericlase_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_SLAB = add("perovskite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PEROVSKITE_SLAB = add("polished_perovskite_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_BRICKS_SLAB = add("perovskite_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block ZIRCON_REFRACTORY_BRICKS_SLAB = add("zircon_refractory_bricks_slab", new RankineSlab(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block RED_GRANITE_STAIRS = add("red_granite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_RED_GRANITE_STAIRS = add("polished_red_granite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block GRANODIORITE_STAIRS = add("granodiorite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_GRANODIORITE_STAIRS = add("polished_granodiorite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block GRANODIORITE_BRICKS_STAIRS = add("granodiorite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_STAIRS = add("hornblende_andesite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_HORNBLENDE_ANDESITE_STAIRS = add("polished_hornblende_andesite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_BRICKS_STAIRS = add("hornblende_andesite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_STAIRS = add("tholeiitic_basalt_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_THOLEIITIC_BASALT_STAIRS = add("polished_tholeiitic_basalt_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_BRICKS_STAIRS = add("tholeiitic_basalt_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_STAIRS = add("gabbro_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GABBRO_STAIRS = add("polished_gabbro_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_BRICKS_STAIRS = add("gabbro_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_ANORTHOSITE_STAIRS = add("polished_anorthosite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block RHYOLITE_STAIRS = add("rhyolite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_RHYOLITE_STAIRS = add("polished_rhyolite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block RHYOLITE_BRICKS_STAIRS = add("rhyolite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_LIMESTONE_STAIRS = add("polished_limestone_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block MARBLE_STAIRS = add("marble_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_MARBLE_STAIRS = add("polished_marble_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block MARBLE_BRICKS_STAIRS = add("marble_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_STAIRS = add("gneiss_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GNEISS_STAIRS = add("polished_gneiss_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_BRICKS_STAIRS = add("gneiss_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_STAIRS = add("schist_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SCHIST_STAIRS = add("polished_schist_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_BRICKS_STAIRS = add("schist_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_STAIRS = add("slate_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SLATE_STAIRS = add("polished_slate_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_BRICKS_STAIRS = add("slate_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_SHALE_STAIRS = add("polished_shale_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_IRONSTONE_STAIRS = add("polished_ironstone_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block BRECCIA_STAIRS = add("breccia_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_BRECCIA_STAIRS = add("polished_breccia_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block BRECCIA_BRICKS_STAIRS = add("breccia_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_PUMICE_STAIRS = add("polished_pumice_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_SCORIA_STAIRS = add("polished_scoria_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block PERIDOTITE_STAIRS = add("peridotite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PERIDOTITE_STAIRS = add("polished_peridotite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PERIDOTITE_BRICKS_STAIRS = add("peridotite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_STAIRS = add("kimberlite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KIMBERLITE_STAIRS = add("polished_kimberlite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_BRICKS_STAIRS = add("kimberlite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_STAIRS = add("komatiite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KOMATIITE_STAIRS = add("polished_komatiite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_BRICKS_STAIRS = add("komatiite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_STAIRS = add("ringwoodite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_RINGWOODITE_STAIRS = add("polished_ringwoodite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_BRICKS_STAIRS = add("ringwoodite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_STAIRS = add("wadsleyite_stairs",new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_WADSLEYITE_STAIRS = add("polished_wadsleyite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_BRICKS_STAIRS = add("wadsleyite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_STAIRS = add("bridgmanite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_BRIDGMANITE_STAIRS = add("polished_bridgmanite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_BRICKS_STAIRS = add("bridgmanite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_STAIRS = add("ferropericlase_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_FERROPERICLASE_STAIRS = add("polished_ferropericlase_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_BRICKS_STAIRS = add("ferropericlase_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_STAIRS = add("perovskite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PEROVSKITE_STAIRS = add("polished_perovskite_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_BRICKS_STAIRS = add("perovskite_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block ZIRCON_REFRACTORY_BRICKS_STAIRS = add("zircon_refractory_bricks_stairs", new RankineStairs(Block.getStateById(0),DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block RED_GRANITE_WALL = add("red_granite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_RED_GRANITE_WALL = add("polished_red_granite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block GRANODIORITE_WALL = add("granodiorite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_GRANODIORITE_WALL = add("polished_granodiorite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block GRANODIORITE_BRICKS_WALL = add("granodiorite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_WALL = add("hornblende_andesite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_HORNBLENDE_ANDESITE_WALL = add("polished_hornblende_andesite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_BRICKS_WALL = add("hornblende_andesite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_WALL = add("tholeiitic_basalt_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_THOLEIITIC_BASALT_WALL = add("polished_tholeiitic_basalt_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_BRICKS_WALL = add("tholeiitic_basalt_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_WALL = add("gabbro_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GABBRO_WALL = add("polished_gabbro_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GABBRO_BRICKS_WALL = add("gabbro_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block ANORTHOSITE_WALL = add("anorthosite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_ANORTHOSITE_WALL = add("polished_anorthosite_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block RHYOLITE_WALL = add("rhyolite_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_RHYOLITE_WALL = add("polished_rhyolite_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block RHYOLITE_BRICKS_WALL = add("rhyolite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block LIMESTONE_WALL = add("limestone_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_LIMESTONE_WALL = add("polished_limestone_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block MARBLE_WALL = add("marble_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_MARBLE_WALL = add("polished_marble_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block MARBLE_BRICKS_WALL = add("marble_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_WALL = add("gneiss_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_GNEISS_WALL = add("polished_gneiss_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block GNEISS_BRICKS_WALL = add("gneiss_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_WALL = add("schist_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SCHIST_WALL = add("polished_schist_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCHIST_BRICKS_WALL = add("schist_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_WALL = add("slate_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_SLATE_WALL = add("polished_slate_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SLATE_BRICKS_WALL = add("slate_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SHALE_WALL = add("shale_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_SHALE_WALL = add("polished_shale_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_IRONSTONE_WALL = add("polished_ironstone_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block BRECCIA_WALL = add("breccia_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_BRECCIA_WALL = add("polished_breccia_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block BRECCIA_BRICKS_WALL = add("breccia_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block PUMICE_WALL = add("pumice_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block POLISHED_PUMICE_WALL = add("polished_pumice_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_SCORIA_WALL = add("polished_scoria_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCORIA_BRICKS_WALL = add("scoria_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block PERIDOTITE_WALL = add("peridotite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PERIDOTITE_WALL = add("polished_peridotite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PERIDOTITE_BRICKS_WALL = add("peridotite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_WALL = add("kimberlite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KIMBERLITE_WALL = add("polished_kimberlite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KIMBERLITE_BRICKS_WALL = add("kimberlite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_WALL = add("komatiite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_KOMATIITE_WALL = add("polished_komatiite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block KOMATIITE_BRICKS_WALL = add("komatiite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_WALL = add("ringwoodite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_RINGWOODITE_WALL = add("polished_ringwoodite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RINGWOODITE_BRICKS_WALL = add("ringwoodite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_WALL = add("wadsleyite_wall",new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_WADSLEYITE_WALL = add("polished_wadsleyite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block WADSLEYITE_BRICKS_WALL = add("wadsleyite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_WALL = add("bridgmanite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_BRIDGMANITE_WALL = add("polished_bridgmanite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block BRIDGMANITE_BRICKS_WALL = add("bridgmanite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_WALL = add("ferropericlase_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_FERROPERICLASE_WALL = add("polished_ferropericlase_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block FERROPERICLASE_BRICKS_WALL = add("ferropericlase_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_WALL = add("perovskite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_PEROVSKITE_WALL = add("polished_perovskite_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block PEROVSKITE_BRICKS_WALL = add("perovskite_bricks_wall", new RankineWall(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block THOLEIITIC_BASALTIC_TUFF = add("tholeiitic_basaltic_tuff", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), BLOCKS);
    ...
    public static final RankineOre PETALITE_ORE = add("petalite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre MAGNESITE_ORE = add("magnesite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    ...
    public static final RankineOre BAUXITE_ORE = add("bauxite_ore", new RankineOre(DEF_ORE.harvestLevel(1)), METALLURGY);
    public static final RankineOre NATIVE_SULFUR_ORE = add("native_sulfur_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre ILMENITE_ORE = add("ilmenite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre VANADINITE_ORE = add("vanadinite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre CHROMITE_ORE = add("chromite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre PYROLUSITE_ORE = add("pyrolusite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre MAGNETITE_ORE = add("magnetite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre COBALTITE_ORE = add("cobaltite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre PENTLANDITE_ORE = add("pentlandite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre INTERSPINIFEX_ORE = add("interspinifex_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre NATIVE_COPPER_ORE = add("native_copper_ore", new RankineOre(DEF_ORE.harvestLevel(0)), METALLURGY);
    public static final RankineOre MALACHITE_ORE = add("malachite_ore", new RankineOre(DEF_ORE.harvestLevel(1)), METALLURGY);
    public static final RankineOre SPHALERITE_ORE = add("sphalerite_ore", new RankineOre(DEF_ORE.harvestLevel(1)), METALLURGY);
    public static final RankineOre NATIVE_GALLIUM_ORE = add("native_gallium_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    ...
    public static final RankineOre NATIVE_SELENIUM_ORE = add("native_selenium_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre CELESTINE_ORE = add("celestine_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre XENOTIME_ORE = add("xenotime_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre COLUMBITE_ORE = add("columbite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre MOLYBDENITE_ORE = add("molybdenite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre NATIVE_SILVER_ORE = add("native_silver_ore", new RankineOre(DEF_ORE.harvestLevel(0)), METALLURGY);
    public static final RankineOre ACANTHITE_ORE = add("acanthite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    public static final RankineOre GREENOCKITE_ORE = add("greenockite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre NATIVE_INDIUM_ORE = add("native_indium_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre NATIVE_TIN_ORE = add("native_tin_ore", new RankineOre(DEF_ORE.harvestLevel(0)), METALLURGY);
    public static final RankineOre CASSITERITE_ORE = add("cassiterite_ore", new RankineOre(DEF_ORE.harvestLevel(1)), METALLURGY);
    public static final RankineOre STIBNITE_ORE = add("stibnite_ore", new RankineOre(DEF_ORE.harvestLevel(0)), METALLURGY);
    public static final RankineOre NATIVE_TELLURIUM_ORE = add("native_tellurium_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre TANTALITE_ORE = add("tantalite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre WOLFRAMITE_ORE = add("wolframite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    ...
    public static final RankineOre GALENA_ORE = add("galena_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    ...
    public static final RankineOre BISMUTHINITE_ORE = add("bismuthinite_ore", new RankineOre(DEF_ORE.harvestLevel(2)), METALLURGY);
    ...
    public static final RankineOre EMERALD_ORE = add("emerald_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre OPAL_ORE = add("opal_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre AQUAMARINE_ORE = add("aquamarine_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    public static final RankineOre MAJORITE_ORE = add("majorite_ore", new RankineOre(DEF_ORE.harvestLevel(3)), METALLURGY);
    ...
    public static final RankineOre CINNABAR_ORE = add("cinnabar_ore", new RankineOre(DEF_ORE.harvestLevel(1)), METALLURGY);
