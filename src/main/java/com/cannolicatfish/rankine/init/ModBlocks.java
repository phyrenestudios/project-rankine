...
//-------------------------------------
    ...
    public static final Block SMOOTH_ROMAN_CONCRETE = add("polished_roman_concrete", new MovementModifierBlock(1.4D,Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), BLOCKS);
    public static final Block SMOOTH_ROMAN_CONCRETE_SLAB = add("polished_roman_concrete_slab", new RankineSlab(1.4D,Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), BLOCKS);
    public static final Block SMOOTH_ROMAN_CONCRETE_STAIRS = add("polished_roman_concrete_stairs", new RankineStairs(1.4D,Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), BLOCKS);
