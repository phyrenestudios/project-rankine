...
//-------------------------------------
    ...
    public static final Block RED_GRANITE_WALL = add("red_granite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_RED_GRANITE_WALL = add("polished_red_granite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block GRANODIORITE_WALL = add("granodiorite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_GRANODIORITE_WALL = add("polished_granodiorite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block GRANODIORITE_BRICKS_WALL = add("granodiorite_bricks_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_WALL = add("hornblende_andesite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_HORNBLENDE_ANDESITE_WALL = add("polished_hornblende_andesite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block HORNBLENDE_ANDESITE_BRICKS_WALL = add("hornblende_andesite_bricks_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block LIMESTONE_WALL = add("limestone_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    public static final Block POLISHED_LIMESTONE_WALL = add("polished_limestone_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_SHALE_WALL = add("polished_shale_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_ANORTHOSITE_WALL = add("polished_anorthosite_wall", new WallBlock(DEF_STONE.harvestLevel(0)), BLOCKS);
    ...
    public static final Block POLISHED_IRONSTONE_WALL = add("polished_ironstone_wall", new WallBlock(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block IRONSTONE_BRICKS_WALL = add("ironstone_bricks_wall", new WallBlock(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_WALL = add("tholeiitic_basalt_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_THOLEIITIC_BASALT_WALL = add("polished_tholeiitic_basalt_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block THOLEIITIC_BASALT_BRICKS_WALL = add("tholeiitic_basalt_bricks_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block RHYOLITE_WALL = add("rhyolite_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    public static final Block POLISHED_RHYOLITE_WALL = add("polished_rhyolite_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block POLISHED_MARBLE_WALL = add("polished_marble_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block POLISHED_GNEISS_WALL = add("polished_gneiss_wall", new WallBlock(DEF_STONE.harvestLevel(2)), BLOCKS);
    ...
    public static final Block POLISHED_PERIDOTITE_WALL = add("polished_peridotite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_RINGWOODITE_WALL = add("polished_ringwoodite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_WADSLEYITE_WALL = add("polished_wadsleyite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_BRIDGMANITE_WALL = add("polished_bridgmanite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_KOMATIITE_WALL = add("polished_komatiite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_KIMBERLITE_WALL = add("polished_kimberlite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_FERROPERICLASE_WALL = add("polished_ferropericlase_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_PEROVSKITE_WALL = add("polished_perovskite_wall", new WallBlock(DEF_STONE.harvestLevel(3)), BLOCKS);
    ...
    public static final Block POLISHED_PUMICE_WALL = add("polished_pumice_wall", new WallBlock(DEF_STONE.harvestLevel(1)), BLOCKS);
    ...
    public static final Block POLISHED_SCORIA_WALL = add("polished_scoria_wall", new WallBlock(DEF_STONE.harvestLevel(1)), BLOCKS);
    public static final Block SCORIA_BRICKS_WALL = add("scoria_bricks_wall", new WallBlock(DEF_STONE.harvestLevel(1)), BLOCKS);

    public static final Block GRANITE_BUTTON = add("red_granite_button", new RankineStoneButton(), BLOCKS);
    public static final Block DIORITE_BUTTON = add("granodiorite_button", new RankineStoneButton(), BLOCKS);
    public static final Block ANDESITE_BUTTON = add("hornblende_andesite_button", new RankineStoneButton(), BLOCKS);
    public static final Block LIMESTONE_BUTTON = add("limestone_button", new RankineStoneButton(), BLOCKS);
    public static final Block SHALE_BUTTON = add("shale_button", new RankineStoneButton(), BLOCKS);
    public static final Block ANORTHOSITE_BUTTON = add("anorthosite_button", new RankineStoneButton(), BLOCKS);
    public static final Block IRONSTONE_BUTTON = add("ironstone_button", new RankineStoneButton(), BLOCKS);
    public static final Block THOLEIITIC_BASALT_BUTTON = add("tholeiitic_basalt_button", new RankineStoneButton(), BLOCKS);
    public static final Block RHYOLITE_BUTTON = add("rhyolite_button", new RankineStoneButton(), BLOCKS);
    public static final Block MARBLE_BUTTON = add("marble_button", new RankineStoneButton(), BLOCKS);
    public static final Block GNEISS_BUTTON = add("gneiss_button", new RankineStoneButton(), BLOCKS);
    public static final Block PERIDOTITE_BUTTON = add("peridotite_button", new RankineStoneButton(), BLOCKS);
    public static final Block RINGWOODITE_BUTTON = add("ringwoodite_button", new RankineStoneButton(), BLOCKS);
    public static final Block WADSLEYITE_BUTTON = add("wadsleyite_button", new RankineStoneButton(), BLOCKS);
    public static final Block BRIDGMANITE_BUTTON = add("bridgmanite_button", new RankineStoneButton(), BLOCKS);
    public static final Block KOMATIITE_BUTTON = add("komatiite_button", new RankineStoneButton(), BLOCKS);
    public static final Block KIMBERLITE_BUTTON = add("kimberlite_button", new RankineStoneButton(), BLOCKS);
    public static final Block FERROPERICLASE_BUTTON = add("ferropericlase_button", new RankineStoneButton(), BLOCKS);
    ...
    public static final Block GRANITE_PRESSURE_PLATE = add("red_granite_pressure_plate", new RankineStonePressurePlate(), BLOCKS);
    public static final Block DIORITE_PRESSURE_PLATE = add("granodiorite_pressure_plate", new RankineStonePressurePlate(), BLOCKS);
    public static final Block ANDESITE_PRESSURE_PLATE = add("hornblende_andesite_pressure_plate", new RankineStonePressurePlate(), BLOCKS);
