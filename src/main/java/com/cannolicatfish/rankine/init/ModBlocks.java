...
//-------------------------------------
    ...
    public static final Block GRANITE_BUTTON = add("granite_button", new RankineStoneButton(), BLOCKS);
    public static final Block DIORITE_BUTTON = add("diorite_button", new RankineStoneButton(), BLOCKS);
    public static final Block ANDESITE_BUTTON = add("andesite_button", new RankineStoneButton(), BLOCKS);
    ...
    public static final Block BASALT_BUTTON = add("basalt_button", new RankineStoneButton(), BLOCKS);
    ...
    public static final Block ANDESITE_PRESSURE_PLATE = add("andesite_pressure_plate", new RankineStonePressurePlate(), BLOCKS);
    ...
    public static final Block BASALT_PRESSURE_PLATE = add("basalt_pressure_plate", new RankineStonePressurePlate(), BLOCKS);
