...
public class ModEntityTypes {
    ...
    public static final EntityType<SpearEntity> PEWTER_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.PEWTER_SPEAR,new ResourceLocation("rankine:textures/entity/pewter_spear.png"))).size(0.5F, 0.5F),"pewter_spear");
