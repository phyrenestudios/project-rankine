...
public class ModFeatures {
    ...
    public static final ConfiguredFeature<?,?> ANDESITIC_TUFF = new ModularOreFeature(OreFeatureConfig.CODEC, ModBlocks.HORNBLENDE_ANDESITE.getDefaultState()).withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.ANDESITIC_TUFF.getDefaultState(), 60))
            .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(64, 0, 128))).square().func_242731_b(1);
    public static final ConfiguredFeature<?,?> RHYOLITIC_TUFF = new ModularOreFeature(OreFeatureConfig.CODEC, ModBlocks.RHYOLITE.getDefaultState()).withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.RHYOLITIC_TUFF.getDefaultState(), 60))
            .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(64, 0, 128))).square().func_242731_b(1);
    public static final ConfiguredFeature<?,?> THOLEIITIC_BASALTIC_TUFF = new ModularOreFeature(OreFeatureConfig.CODEC, ModBlocks.THOLEIITIC_BASALT.getDefaultState()).withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.THOLEIITIC_BASALTIC_TUFF.getDefaultState(), 60))
            .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(64, 0, 128))).square().func_242731_b(1);
    ...
    public static final ConfiguredFeature<?,?> ORE_CINNABAR = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.NO_SPM, ModBlocks.CINNABAR_ORE.getStateContainer().getBaseState(), Config.CINNABAR_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_CHROMITE = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.NO_SPM, ModBlocks.CHROMITE_ORE.getStateContainer().getBaseState(), Config.CHROMITE_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_CELESTINE = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.NO_SPM, ModBlocks.CELESTINE_ORE.getStateContainer().getBaseState(), Config.CELESTINE_ORE_SIZE.get()))
    ...
    // MISC ORES
    public static final ConfiguredFeature<?,?> ORE_LAZURITE = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.OVERWORLD, ModBlocks.LAZURITE_ORE.getStateContainer().getBaseState(), Config.LAZURITE_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_MAJORITE = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.OVERWORLD, ModBlocks.MAJORITE_ORE.getStateContainer().getBaseState(), Config.MAJORITE_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_PLUMBAGO = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.OVERWORLD, ModBlocks.PLUMBAGO_ORE.getStateContainer().getBaseState(), Config.PLUMBAGO_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_MOLYBDENITE_END = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.END, ModBlocks.MOLYBDENITE_ORE.getStateContainer().getBaseState(), Config.MOLYBDENITE_ORE_SIZE.get()))
            .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(Config.MOLYBDENITE_ORE_MIN_HEIGHT.get(), 0, Config.MOLYBDENITE_ORE_MAX_HEIGHT.get()))).square().func_242731_b(Config.MOLYBDENITE_ORE_COUNT.get());
