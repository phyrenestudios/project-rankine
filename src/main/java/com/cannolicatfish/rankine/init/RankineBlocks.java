...
public class RankineBlocks {
    ...
    public static final RegistryObject<Block> POLISHED_PEGMATITE = REGISTRY.register("polished_pegmatite", () -> new RankinePolishedStoneBlock(POLISHED_METAMORPHIC_STONE));
    public static final RegistryObject<Block> PEGMATITE_BRICKS = REGISTRY.register("pegmatite_bricks", () -> new RankineStoneBricksBlock(METAMORPHIC_STONE_BRICKS));
    ...
    public static final RegistryObject<Block> ASPHALT_0 = REGISTRY.register("asphalt0", () -> new Asphalt0Block(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(0)));
    public static final RegistryObject<Block> ASPHALT_1 = REGISTRY.register("asphalt1", () -> new Asphalt1Block(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(0)));
    public static final RegistryObject<Block> ASPHALT_2 = REGISTRY.register("asphalt2", () -> new Asphalt2Block(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(0)));
    public static final RegistryObject<Block> ASPHALT_3 = REGISTRY.register("asphalt3", () -> new Asphalt3Block(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(0)));
    ...
    public static final RegistryObject<Block> COBBLE = REGISTRY.register("cobble", () -> new CobbleBlock(AbstractBlock.Properties.create(Material.ROCK).sound(SoundType.STONE).setRequiresTool().harvestTool(ToolType.PICKAXE).hardnessAndResistance(0.5F, 3.0F).harvestLevel(0)));
