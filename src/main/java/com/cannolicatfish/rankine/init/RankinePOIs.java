...
public class RankinePOIs {
    ...
    public static final PointOfInterestType GEM_CUTTER_POI = new PointOfInterestType("gem_cutter_poi", ImmutableSet.copyOf(getAllStates(RankineBlocks.UNCUT_GEODE.get())), 1, 1);
