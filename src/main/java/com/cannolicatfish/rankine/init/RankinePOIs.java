...
public class RankinePOIs {
    ...
    public static final RegistryObject<PoiType> PISTON_CRUSHER_POI = POI_TYPES.register("piston_crusher_poi", () -> new PoiType("piston_crusher_poi", ImmutableSet.copyOf(getAllStates(RankineBlocks.PISTON_CRUSHER.get())), 1, 1));
    ...
    public static final RegistryObject<PoiType> GEM_CUTTER_POI = POI_TYPES.register("gem_cutter_poi", () -> new PoiType("gem_cutter_poi", ImmutableSet.copyOf(getAllStates(RankineBlocks.DIAMOND_ANVIL_CELL.get())), 1, 1));
