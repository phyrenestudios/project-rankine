...
public class RankinePOIs {
    ...
    public static final RegistryObject<PoiType> PISTON_CRUSHER_POI = POI_TYPES.register("piston_crusher_poi", () -> new PoiType( ImmutableSet.copyOf(getAllStates(RankineBlocks.WOOD_TIER_CRUSHING_HEAD.get())), 1, 1));
