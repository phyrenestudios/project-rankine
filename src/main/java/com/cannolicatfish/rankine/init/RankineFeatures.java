...
public class RankineFeatures {
    ...
    public static final ConfiguredFeature<?, ?> THOLEIITIC_BASALTIC_TUFF = BASALTIC_TUFF_FEATURE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, RankineBlocks.BASALTIC_TUFF.get().getDefaultState(), 64))
            .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(0, 0, 60))).square().count(1);
    public static final ConfiguredFeature<?, ?> DACITIC_TUFF = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.DACITES, RankineBlocks.KIMBERLITIC_TUFF.get().getStateContainer().getBaseState(), 60))
            .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(0, 0, 60))).square().count(1);
    ...
    public static final ConfiguredFeature<?,?> ORE_COLUMBITE_COUNT = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.COLUMBITE, RankineBlocks.COLTAN_ORE.get().getStateContainer().getBaseState(), WGConfig.ORES.COLUMBITE_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_COLUMBITE_CHANCE = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.COLUMBITE, RankineBlocks.COLTAN_ORE.get().getStateContainer().getBaseState(), WGConfig.ORES.COLUMBITE_ORE_SIZE.get()))
    ...
    public static final ConfiguredFeature<?,?> ORE_COLUMBITE_MEGA = RANKINE_ORE.withConfiguration(new RankineOreFeatureConfig(RankineOreFeatureConfig.RankineFillerBlockType.COLUMBITE, RankineBlocks.COLTAN_ORE.get().getStateContainer().getBaseState(), WGConfig.ORES.COLUMBITE_ORE_MEGA_SIZE.get()))
