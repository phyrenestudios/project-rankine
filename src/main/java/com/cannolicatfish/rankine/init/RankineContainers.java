...
public class RankineContainers {
    ...
    public static RegistryObject<MenuType<PistonCrusherContainer>> PISTON_CRUSHER_CONTAINER = CONTAINERS.register("piston_crusher", () -> IForgeMenuType.create((windowId, inv, data) -> new PistonCrusherContainer(windowId, ProjectRankine.proxy.getClientWorld(), data.readBlockPos(), inv, ProjectRankine.proxy.getClientPlayer())));
    ...
    public static RegistryObject<MenuType<GyratoryCrusherContainer>> GYRATORY_CRUSHER_CONTAINER = CONTAINERS.register("gyratory_crusher", () -> IForgeMenuType.create((windowId, inv, data) -> new GyratoryCrusherContainer(windowId, ProjectRankine.proxy.getClientWorld(), data.readBlockPos(), inv, ProjectRankine.proxy.getClientPlayer())));
