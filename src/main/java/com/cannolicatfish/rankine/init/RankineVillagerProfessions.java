...
public class RankineVillagerProfessions {
    ...
    public static final VillagerProfession GEM_CUTTER = new VillagerProfession("gem_cutter", RankinePOIs.RANKINE_BOX_POI, ImmutableSet.of(), ImmutableSet.of(), SoundEvents.BLOCK_GLASS_PLACE);
}
