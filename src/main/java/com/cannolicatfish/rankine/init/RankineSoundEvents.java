...
public class RankineSoundEvents {
    ...
    public static final RegistryObject<SoundEvent> SEDIMENT_FAN_GEN = REGISTRY.register("sediment_fan_gen",() -> new SoundEvent(new ResourceLocation("rankine:sediment_fan_gen")));
}
