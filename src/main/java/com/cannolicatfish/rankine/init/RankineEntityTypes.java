...
public class RankineEntityTypes {
    public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITIES, ProjectRankine.MODID);

    public static final RegistryObject<EntityType<SpearEntity>> ALLOY_SPEAR = REGISTRY.register("alloy_spear",
    ...
    public static final RegistryObject<EntityType<RopeCoilArrowEntity>> ROPE_COIL_ARROW = REGISTRY.register("rope_coil_arrow",
    ...
    public static final RegistryObject<EntityType<AlloyArrowEntity>> ALLOY_ARROW = REGISTRY.register("alloy_arrow",
    ...
    public static final RegistryObject<EntityType<RankineBoatEntity>> RANKINE_BOAT = REGISTRY.register("rankine_boat",
    ...
    public static final RegistryObject<EntityType<ReactiveItemEntity>> REACTIVE_ITEM = REGISTRY.register("reactive_item",
    ...
    public static final RegistryObject<EntityType<CannonballEntity>> CANNONBALL =  REGISTRY.register("cannonball",
    ...
    public static final RegistryObject<EntityType<EnderballEntity>> ENDERBALL =  REGISTRY.register("enderball",
    ...
    public static final RegistryObject<EntityType<CarcassEntity>> CARCASS =  REGISTRY.register("carcass",
