...
//CRUSHED ORES
    ...
    public static final Item LONSDALEITE_DIAMOND = add("lonsdaleite_diamond", new Item(new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    public static final Item PEARL = add("pearl", new Item(new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    public static final Item TRONA = add("trona", new Item(new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    public static final Item RHODONITE = add("rhodonite", new Item(new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    public static final Item RHODOCHROSITE = add("rhodochrosite", new Item(new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    ...
    public static final AlloyItem BRONZE_ALLOY = add("bronze_alloy", new AlloyItem(AlloyUtilsEnum.BRONZE.getDefComposition(),new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    ...
    public static final AlloyItem STAINLESS_STEEL_ALLOY = add("stainless_steel_alloy", new AlloyItem(AlloyUtilsEnum.STAINLESS.getDefComposition(),new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
    ...
    public static final AlloyItem AMALGAM_ALLOY = add("amalgam_alloy", new AlloyItem(AlloyUtilsEnum.AMALGAM.getDefComposition(),new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineMetals)));
...
//RANKINE MISC CREATIVE TAB --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public static final Item  PEWTER_SWORD = add("pewter_sword", new AlloySword(RankineToolMaterials.PEWTER, 3, -2.4F, AlloyUtilsEnum.PEWTER,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PEWTER_SHOVEL = add("pewter_shovel", new AlloyShovel(RankineToolMaterials.PEWTER, 1.5F, -3.0F, AlloyUtilsEnum.PEWTER, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PEWTER_PICKAXE = add("pewter_pickaxe", new AlloyPickaxe(RankineToolMaterials.PEWTER, 1, -2.8F, AlloyUtilsEnum.PEWTER, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  PEWTER_AXE = add("pewter_axe", new AlloyAxe(RankineToolMaterials.PEWTER, 4.0F, -3.2F, AlloyUtilsEnum.PEWTER,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PEWTER_HAMMER = add("pewter_hammer", new AlloyHammer(RankineToolMaterials.PEWTER,2, -3.2F, AlloyUtilsEnum.PEWTER,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PEWTER_HOE = add("pewter_hoe", new AlloyHoe(RankineToolMaterials.PEWTER, 0,-2.0F, AlloyUtilsEnum.PEWTER,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PEWTER_SPEAR = add("pewter_spear", new AlloySpear(RankineToolMaterials.PEWTER, 2, -2.9F, AlloyUtilsEnum.PEWTER,ModEntityTypes.PEWTER_SPEAR,new ResourceLocation("rankine:textures/entity/pewter_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  BRONZE_SWORD = add("bronze_sword", new AlloySword(RankineToolMaterials.BRONZE, 3, -2.4F, AlloyUtilsEnum.BRONZE,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BRONZE_SHOVEL = add("bronze_shovel", new AlloyShovel(RankineToolMaterials.BRONZE, 1.5F, -3.0F, AlloyUtilsEnum.BRONZE, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final AlloyPickaxe BRONZE_PICKAXE = add("bronze_pickaxe", new AlloyPickaxe(RankineToolMaterials.BRONZE, 1, -2.8F, AlloyUtilsEnum.BRONZE, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  BRONZE_AXE = add("bronze_axe", new AlloyAxe(RankineToolMaterials.BRONZE, 4.0F, -3.2F, AlloyUtilsEnum.BRONZE,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BRONZE_HAMMER = add("bronze_hammer", new AlloyHammer(RankineToolMaterials.BRONZE,2, -3.2F, AlloyUtilsEnum.BRONZE,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BRONZE_HOE = add("bronze_hoe", new AlloyHoe(RankineToolMaterials.BRONZE, -1,-2.0F, AlloyUtilsEnum.BRONZE,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BRONZE_SPEAR = add("bronze_spear", new AlloySpear(RankineToolMaterials.BRONZE, 2, -2.9F, AlloyUtilsEnum.BRONZE,ModEntityTypes.BRONZE_SPEAR,new ResourceLocation("rankine:textures/entity/bronze_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    ...
    public static final Item  METEORIC_IRON_SWORD = add("meteoric_iron_sword", new AlloySword(RankineToolMaterials.INVAR, 3, -2.4F, AlloyUtilsEnum.INVAR,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  METEORIC_IRON_SHOVEL = add("meteoric_iron_shovel", new AlloyShovel(RankineToolMaterials.INVAR, 1.5F, -3.0F, AlloyUtilsEnum.INVAR,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  METEORIC_IRON_PICKAXE = add("meteoric_iron_pickaxe", new AlloyPickaxe(RankineToolMaterials.INVAR, 1, -2.8F,AlloyUtilsEnum.INVAR,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  METEORIC_IRON_AXE = add("meteoric_iron_axe", new AlloyAxe(RankineToolMaterials.INVAR, 4.0F, -3.2F, AlloyUtilsEnum.INVAR, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  METEORIC_IRON_HAMMER = add("meteoric_iron_hammer", new AlloyHammer(RankineToolMaterials.INVAR, 2, -3.2F, AlloyUtilsEnum.INVAR, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  METEORIC_IRON_HOE = add("meteoric_iron_hoe", new AlloyHoe(RankineToolMaterials.INVAR, -2, -1.0F, AlloyUtilsEnum.INVAR,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  METEORIC_IRON_SPEAR = add("meteoric_iron_spear", new AlloySpear(RankineToolMaterials.INVAR,2, -2.9F, AlloyUtilsEnum.INVAR,ModEntityTypes.METEORIC_IRON_SPEAR,new ResourceLocation("rankine:textures/entity/meteoric_iron_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  STEEL_SWORD = add("steel_sword", new AlloySword(RankineToolMaterials.STEEL, 3, -2.4F, AlloyUtilsEnum.STEEL,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STEEL_SHOVEL = add("steel_shovel", new AlloyShovel(RankineToolMaterials.STEEL, 1.5F, -3.0F, AlloyUtilsEnum.STEEL,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STEEL_PICKAXE = add("steel_pickaxe", new AlloyPickaxe(RankineToolMaterials.STEEL, 1, -2.8F, AlloyUtilsEnum.STEEL,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STEEL_AXE = add("steel_axe", new AlloyAxe(RankineToolMaterials.STEEL, 4.0F, -3.2F, AlloyUtilsEnum.STEEL,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STEEL_HAMMER = add("steel_hammer", new AlloyHammer(RankineToolMaterials.STEEL,2, -3.2F,  AlloyUtilsEnum.STEEL,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STEEL_HOE = add("steel_hoe", new AlloyHoe(RankineToolMaterials.STEEL, -3,0.0F, AlloyUtilsEnum.STEEL,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STEEL_SPEAR = add("steel_spear", new AlloySpear(RankineToolMaterials.STEEL, 2, -2.9F, AlloyUtilsEnum.STEEL,ModEntityTypes.STEEL_SPEAR,new ResourceLocation("rankine:textures/entity/steel_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  STAINLESS_STEEL_SWORD = add("stainless_steel_sword", new AlloySword(RankineToolMaterials.STAINLESS, 3, -2.4F, AlloyUtilsEnum.STAINLESS,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STAINLESS_STEEL_SHOVEL = add("stainless_steel_shovel", new AlloyShovel(RankineToolMaterials.STAINLESS, 1.5F, -3.0F, AlloyUtilsEnum.STAINLESS,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STAINLESS_STEEL_PICKAXE = add("stainless_steel_pickaxe", new AlloyPickaxe(RankineToolMaterials.STAINLESS, 1, -2.8F, AlloyUtilsEnum.STAINLESS,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STAINLESS_STEEL_AXE = add("stainless_steel_axe", new AlloyAxe(RankineToolMaterials.STAINLESS, 4.0F, -3.2F, AlloyUtilsEnum.STAINLESS,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STAINLESS_STEEL_HAMMER = add("stainless_steel_hammer", new AlloyHammer(RankineToolMaterials.STAINLESS,2, -3.2F,  AlloyUtilsEnum.STAINLESS,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STAINLESS_STEEL_HOE = add("stainless_steel_hoe", new AlloyHoe(RankineToolMaterials.STAINLESS, -3,0.0F, AlloyUtilsEnum.STAINLESS,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  STAINLESS_STEEL_SPEAR = add("stainless_steel_spear", new AlloySpear(RankineToolMaterials.STAINLESS, 2, -2.9F, AlloyUtilsEnum.STAINLESS,ModEntityTypes.STAINLESS_STEEL_SPEAR,new ResourceLocation("rankine:textures/entity/stainless_steel_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  NICKEL_SUPERALLOY_SWORD = add("nickel_superalloy_sword", new AlloySword(RankineToolMaterials.NICKEL_SA, 3, -2.4F, AlloyUtilsEnum.NICKEL_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  NICKEL_SUPERALLOY_SHOVEL = add("nickel_superalloy_shovel", new AlloyShovel(RankineToolMaterials.NICKEL_SA, 1.5F, -3.0F, AlloyUtilsEnum.NICKEL_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  NICKEL_SUPERALLOY_PICKAXE = add("nickel_superalloy_pickaxe", new AlloyPickaxe(RankineToolMaterials.NICKEL_SA, 1, -2.8F, AlloyUtilsEnum.NICKEL_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  NICKEL_SUPERALLOY_AXE = add("nickel_superalloy_axe", new AlloyAxe(RankineToolMaterials.NICKEL_SA, 4.0F, -3.2F, AlloyUtilsEnum.NICKEL_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  NICKEL_SUPERALLOY_HAMMER = add("nickel_superalloy_hammer", new AlloyHammer(RankineToolMaterials.NICKEL_SA,2, -3.2F,  AlloyUtilsEnum.NICKEL_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  NICKEL_SUPERALLOY_HOE = add("nickel_superalloy_hoe", new AlloyHoe(RankineToolMaterials.NICKEL_SA, -3,0.0F, AlloyUtilsEnum.NICKEL_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  NICKEL_SUPERALLOY_SPEAR = add("nickel_superalloy_spear", new AlloySpear(RankineToolMaterials.NICKEL_SA, 2, -2.9F, AlloyUtilsEnum.NICKEL_SA,ModEntityTypes.NICKEL_SUPERALLOY_SPEAR,new ResourceLocation("rankine:textures/entity/nickel_superalloy_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  COBALT_SUPERALLOY_SWORD = add("cobalt_superalloy_sword", new AlloySword(RankineToolMaterials.COBALT_SA, 3, -2.4F, AlloyUtilsEnum.COBALT_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  COBALT_SUPERALLOY_SHOVEL = add("cobalt_superalloy_shovel", new AlloyShovel(RankineToolMaterials.COBALT_SA, 1.5F, -3.0F, AlloyUtilsEnum.COBALT_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  COBALT_SUPERALLOY_PICKAXE = add("cobalt_superalloy_pickaxe", new AlloyPickaxe(RankineToolMaterials.COBALT_SA, 1, -2.8F, AlloyUtilsEnum.COBALT_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  COBALT_SUPERALLOY_AXE = add("cobalt_superalloy_axe", new AlloyAxe(RankineToolMaterials.COBALT_SA, 4.0F, -3.2F, AlloyUtilsEnum.COBALT_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  COBALT_SUPERALLOY_HAMMER = add("cobalt_superalloy_hammer", new AlloyHammer(RankineToolMaterials.COBALT_SA,2, -3.2F,  AlloyUtilsEnum.COBALT_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  COBALT_SUPERALLOY_HOE = add("cobalt_superalloy_hoe", new AlloyHoe(RankineToolMaterials.COBALT_SA, -3,0.0F, AlloyUtilsEnum.COBALT_SA,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  COBALT_SUPERALLOY_SPEAR = add("cobalt_superalloy_spear", new AlloySpear(RankineToolMaterials.COBALT_SA, 2, -2.9F, AlloyUtilsEnum.COBALT_SA,ModEntityTypes.COBALT_SUPERALLOY_SPEAR,new ResourceLocation("rankine:textures/entity/cobalt_superalloy_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  TUNGSTEN_HEAVY_ALLOY_SWORD = add("tungsten_heavy_alloy_sword", new AlloySword(RankineToolMaterials.TUNGSTEN, 3, -2.4F, AlloyUtilsEnum.TUNGSTEN,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  TUNGSTEN_HEAVY_ALLOY_SHOVEL = add("tungsten_heavy_alloy_shovel", new AlloyShovel(RankineToolMaterials.TUNGSTEN, 1.5F, -3.0F, AlloyUtilsEnum.TUNGSTEN,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  TUNGSTEN_HEAVY_ALLOY_PICKAXE = add("tungsten_heavy_alloy_pickaxe", new AlloyPickaxe(RankineToolMaterials.TUNGSTEN, 1, -2.8F, AlloyUtilsEnum.TUNGSTEN,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  TUNGSTEN_HEAVY_ALLOY_AXE = add("tungsten_heavy_alloy_axe", new AlloyAxe(RankineToolMaterials.TUNGSTEN, 4.0F, -3.2F, AlloyUtilsEnum.TUNGSTEN,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  TUNGSTEN_HEAVY_ALLOY_HAMMER = add("tungsten_heavy_alloy_hammer", new AlloyHammer(RankineToolMaterials.TUNGSTEN,2, -3.2F,  AlloyUtilsEnum.TUNGSTEN,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  TUNGSTEN_HEAVY_ALLOY_HOE = add("tungsten_heavy_alloy_hoe", new AlloyHoe(RankineToolMaterials.TUNGSTEN, -3,0.0F, AlloyUtilsEnum.TUNGSTEN,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  TUNGSTEN_HEAVY_ALLOY_SPEAR = add("tungsten_heavy_alloy_spear", new AlloySpear(RankineToolMaterials.TUNGSTEN, 2, -2.9F, AlloyUtilsEnum.TUNGSTEN,ModEntityTypes.TUNGSTEN_HEAVY_ALLOY_SPEAR,new ResourceLocation("rankine:textures/entity/tungsten_heavy_alloy_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    //GOLD TOOLS
    public static final Item  ROSE_GOLD_SWORD = add("rose_gold_sword", new AlloySword(RankineToolMaterials.ROSE_GOLD,3, -2.4F, AlloyUtilsEnum.ROSE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ROSE_GOLD_SHOVEL = add("rose_gold_shovel", new AlloyShovel(RankineToolMaterials.ROSE_GOLD,1.5F, -3.0F, AlloyUtilsEnum.ROSE_GOLD, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ROSE_GOLD_PICKAXE = add("rose_gold_pickaxe", new AlloyPickaxe(RankineToolMaterials.ROSE_GOLD, 1, -2.8F, AlloyUtilsEnum.ROSE_GOLD, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  ROSE_GOLD_AXE = add("rose_gold_axe", new AlloyAxe(RankineToolMaterials.ROSE_GOLD,4.0F, -3.2F, AlloyUtilsEnum.ROSE_GOLD, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ROSE_GOLD_HAMMER = add("rose_gold_hammer", new AlloyHammer(RankineToolMaterials.ROSE_GOLD,2, -3.2F, AlloyUtilsEnum.ROSE_GOLD, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ROSE_GOLD_HOE = add("rose_gold_hoe", new AlloyHoe(RankineToolMaterials.ROSE_GOLD, 0,-3.0F, AlloyUtilsEnum.ROSE_GOLD, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ROSE_GOLD_SPEAR = add("rose_gold_spear", new AlloySpear(RankineToolMaterials.ROSE_GOLD,2, -2.9F, AlloyUtilsEnum.ROSE_GOLD,ModEntityTypes.ROSE_GOLD_SPEAR,new ResourceLocation("rankine:textures/entity/rose_gold_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  WHITE_GOLD_SWORD = add("white_gold_sword", new AlloySword(RankineToolMaterials.WHITE_GOLD,3, -2.4F, AlloyUtilsEnum.WHITE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  WHITE_GOLD_SHOVEL = add("white_gold_shovel", new AlloyShovel(RankineToolMaterials.WHITE_GOLD,1.5F, -3.0F,AlloyUtilsEnum.WHITE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  WHITE_GOLD_PICKAXE = add("white_gold_pickaxe", new AlloyPickaxe(RankineToolMaterials.WHITE_GOLD, 1, -2.8F, AlloyUtilsEnum.WHITE_GOLD, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  WHITE_GOLD_AXE = add("white_gold_axe", new AlloyAxe(RankineToolMaterials.WHITE_GOLD,4.0F, -3.2F,AlloyUtilsEnum.WHITE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  WHITE_GOLD_HAMMER = add("white_gold_hammer", new AlloyHammer(RankineToolMaterials.WHITE_GOLD,2, -3.2F,  AlloyUtilsEnum.WHITE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  WHITE_GOLD_HOE = add("white_gold_hoe", new AlloyHoe(RankineToolMaterials.WHITE_GOLD,0,-3.0F,AlloyUtilsEnum.WHITE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  WHITE_GOLD_SPEAR = add("white_gold_spear", new AlloySpear(RankineToolMaterials.WHITE_GOLD,2, -2.9F,AlloyUtilsEnum.WHITE_GOLD,ModEntityTypes.WHITE_GOLD_SPEAR,new ResourceLocation("rankine:textures/entity/white_gold_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  GREEN_GOLD_SWORD = add("green_gold_sword", new AlloySword(RankineToolMaterials.GREEN_GOLD,3, -2.4F, AlloyUtilsEnum.GREEN_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  GREEN_GOLD_SHOVEL = add("green_gold_shovel", new AlloyShovel(RankineToolMaterials.GREEN_GOLD,1.5F, -3.0F, AlloyUtilsEnum.GREEN_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  GREEN_GOLD_PICKAXE = add("green_gold_pickaxe", new AlloyPickaxe(RankineToolMaterials.GREEN_GOLD, 1, -2.8F, AlloyUtilsEnum.GREEN_GOLD, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  GREEN_GOLD_AXE = add("green_gold_axe", new AlloyAxe(RankineToolMaterials.GREEN_GOLD,4.0F, -3.2F, AlloyUtilsEnum.GREEN_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  GREEN_GOLD_HAMMER = add("green_gold_hammer", new AlloyHammer(RankineToolMaterials.GREEN_GOLD,2, -3.2F,AlloyUtilsEnum.GREEN_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  GREEN_GOLD_HOE = add("green_gold_hoe", new AlloyHoe(RankineToolMaterials.GREEN_GOLD,0,-3.0F, AlloyUtilsEnum.GREEN_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  GREEN_GOLD_SPEAR = add("green_gold_spear", new AlloySpear(RankineToolMaterials.GREEN_GOLD,2, -2.9F, AlloyUtilsEnum.GREEN_GOLD,ModEntityTypes.GREEN_GOLD_SPEAR,new ResourceLocation("rankine:textures/entity/green_gold_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  BLUE_GOLD_SWORD = add("blue_gold_sword", new AlloySword(RankineToolMaterials.BLUE_GOLD,3, -2.4F, AlloyUtilsEnum.BLUE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLUE_GOLD_SHOVEL = add("blue_gold_shovel", new AlloyShovel(RankineToolMaterials.BLUE_GOLD,1.5F, -3.0F, AlloyUtilsEnum.BLUE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLUE_GOLD_PICKAXE = add("blue_gold_pickaxe", new AlloyPickaxe(RankineToolMaterials.BLUE_GOLD, 1, -2.8F, AlloyUtilsEnum.BLUE_GOLD, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLUE_GOLD_AXE = add("blue_gold_axe", new AlloyAxe(RankineToolMaterials.BLUE_GOLD,4.0F, -3.2F, AlloyUtilsEnum.BLUE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLUE_GOLD_HAMMER = add("blue_gold_hammer", new AlloyHammer(RankineToolMaterials.BLUE_GOLD,2, -3.2F, AlloyUtilsEnum.BLUE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLUE_GOLD_HOE = add("blue_gold_hoe", new AlloyHoe(RankineToolMaterials.BLUE_GOLD,0,-3.0F,AlloyUtilsEnum.BLUE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLUE_GOLD_SPEAR = add("blue_gold_spear", new AlloySpear(RankineToolMaterials.BLUE_GOLD,2, -2.9F, AlloyUtilsEnum.BLUE_GOLD,ModEntityTypes.BLUE_GOLD_SPEAR,new ResourceLocation("rankine:textures/entity/blue_gold_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  PURPLE_GOLD_SWORD = add("purple_gold_sword", new AlloySword(RankineToolMaterials.PURPLE_GOLD,3, -2.4F, AlloyUtilsEnum.PURPLE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PURPLE_GOLD_SHOVEL = add("purple_gold_shovel", new AlloyShovel(RankineToolMaterials.PURPLE_GOLD,1.5F, -3.0F, AlloyUtilsEnum.PURPLE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PURPLE_GOLD_PICKAXE = add("purple_gold_pickaxe", new AlloyPickaxe(RankineToolMaterials.PURPLE_GOLD, 1, -2.8F, AlloyUtilsEnum.PURPLE_GOLD, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  PURPLE_GOLD_AXE = add("purple_gold_axe", new AlloyAxe(RankineToolMaterials.PURPLE_GOLD,4.0F, -3.2F, AlloyUtilsEnum.PURPLE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PURPLE_GOLD_HAMMER = add("purple_gold_hammer", new AlloyHammer(RankineToolMaterials.PURPLE_GOLD,2, -3.2F,AlloyUtilsEnum.PURPLE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PURPLE_GOLD_HOE = add("purple_gold_hoe", new AlloyHoe(RankineToolMaterials.PURPLE_GOLD,0,-3.0F, AlloyUtilsEnum.PURPLE_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  PURPLE_GOLD_SPEAR = add("purple_gold_spear", new AlloySpear(RankineToolMaterials.PURPLE_GOLD,2, -2.9F, AlloyUtilsEnum.PURPLE_GOLD,ModEntityTypes.PURPLE_GOLD_SPEAR,new ResourceLocation("rankine:textures/entity/purple_gold_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    public static final Item  BLACK_GOLD_SWORD = add("black_gold_sword", new AlloySword(RankineToolMaterials.BLACK_GOLD,3, -2.4F, AlloyUtilsEnum.BLACK_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLACK_GOLD_SHOVEL = add("black_gold_shovel", new AlloyShovel(RankineToolMaterials.BLACK_GOLD,1.5F, -3.0F, AlloyUtilsEnum.BLACK_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLACK_GOLD_PICKAXE = add("black_gold_pickaxe", new AlloyPickaxe(RankineToolMaterials.BLACK_GOLD, 1, -2.8F, AlloyUtilsEnum.BLACK_GOLD, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLACK_GOLD_AXE = add("black_gold_axe", new AlloyAxe(RankineToolMaterials.BLACK_GOLD,4.0F, -3.2F, AlloyUtilsEnum.BLACK_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLACK_GOLD_HAMMER = add("black_gold_hammer", new AlloyHammer(RankineToolMaterials.BLACK_GOLD,2, -3.2F, AlloyUtilsEnum.BLACK_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLACK_GOLD_HOE = add("black_gold_hoe", new AlloyHoe(RankineToolMaterials.BLACK_GOLD,0,-3.0F,AlloyUtilsEnum.BLACK_GOLD,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  BLACK_GOLD_SPEAR = add("black_gold_spear", new AlloySpear(RankineToolMaterials.BLACK_GOLD,2, -2.9F, AlloyUtilsEnum.BLACK_GOLD,ModEntityTypes.BLACK_GOLD_SPEAR,new ResourceLocation("rankine:textures/entity/black_gold_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));

    //AMALGAM TOOLS
    public static final Item  AMALGAM_SWORD = add("amalgam_sword", new AlloySword(RankineToolMaterials.AMALGAM, 3, -2.4F, AlloyUtilsEnum.AMALGAM,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  AMALGAM_SHOVEL = add("amalgam_shovel", new AlloyShovel(RankineToolMaterials.AMALGAM, 1.5F, -3.0F, AlloyUtilsEnum.AMALGAM,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  AMALGAM_PICKAXE = add("amalgam_pickaxe", new AlloyPickaxe(RankineToolMaterials.AMALGAM, 1, -2.8F,AlloyUtilsEnum.AMALGAM,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  AMALGAM_AXE = add("amalgam_axe", new AlloyAxe(RankineToolMaterials.AMALGAM, 4.0F, -3.2F, AlloyUtilsEnum.AMALGAM, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  AMALGAM_HAMMER = add("amalgam_hammer", new AlloyHammer(RankineToolMaterials.AMALGAM, 2, -3.2F, AlloyUtilsEnum.AMALGAM, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  AMALGAM_HOE = add("amalgam_hoe", new AlloyHoe(RankineToolMaterials.AMALGAM, 1,-1.0F, AlloyUtilsEnum.AMALGAM,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  AMALGAM_SPEAR = add("amalgam_spear", new AlloySpear(RankineToolMaterials.AMALGAM,2, -2.9F, AlloyUtilsEnum.AMALGAM,ModEntityTypes.AMALGAM_SPEAR,new ResourceLocation("rankine:textures/entity/amalgam_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    ...
    public static final Item  ALLOY_SWORD = add("alloy_sword", new AlloySword(RankineToolMaterials.ALLOY, 3, -2.4F, AlloyUtilsEnum.ALLOY,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ALLOY_SHOVEL = add("alloy_shovel", new AlloyShovel(RankineToolMaterials.ALLOY, 1.5F, -3.0F, AlloyUtilsEnum.ALLOY, new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ALLOY_PICKAXE = add("alloy_pickaxe", new AlloyPickaxe(RankineToolMaterials.ALLOY, 1, -2.8F, AlloyUtilsEnum.ALLOY, (new Item.Properties()).group(ProjectRankine.setup.rankineTools)));
    public static final Item  ALLOY_AXE = add("alloy_axe", new AlloyAxe(RankineToolMaterials.ALLOY, 4.0F, -3.2F, AlloyUtilsEnum.ALLOY,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ALLOY_HAMMER = add("alloy_hammer", new AlloyHammer(RankineToolMaterials.ALLOY,2, -3.2F, AlloyUtilsEnum.ALLOY,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ALLOY_HOE = add("alloy_hoe", new AlloyHoe(RankineToolMaterials.ALLOY, 0,-2.0F, AlloyUtilsEnum.ALLOY,new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    public static final Item  ALLOY_SPEAR = add("alloy_spear", new AlloySpear(RankineToolMaterials.ALLOY, 2, -2.9F, AlloyUtilsEnum.ALLOY,ModEntityTypes.PEWTER_SPEAR,new ResourceLocation("rankine:textures/entity/iron_spear.png"), new Item.Properties().group(ProjectRankine.setup.rankineTools)));
    ...
    public static final Item CAKE_SLICE = add("cake_slice", new Item(new Item.Properties().group(ProjectRankine.setup.rankineTools).food(ModFoods.CHEESE)));
    ...
    public static final Item INDIUM_TIN_OXIDE = add("indium_tin_oxide", new Item(new Item.Properties().maxStackSize(64).group(ProjectRankine.setup.rankineTools)));
