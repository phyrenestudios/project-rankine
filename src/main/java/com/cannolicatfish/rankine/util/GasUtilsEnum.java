...
public enum GasUtilsEnum {
    ...
    RADON(7.5f,0.07f, Arrays.asList(new MobEffectInstance(RankineEffects.RADIATION_POISONING,25),new MobEffectInstance(MobEffects.POISON,25)),true,new Tuple<>(Explosion.BlockInteraction.NONE, 0F),16743053),
