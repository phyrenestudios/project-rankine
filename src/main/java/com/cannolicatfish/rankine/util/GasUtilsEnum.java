...
public enum GasUtilsEnum {
    HYDROGEN(0.1f,0.7f, Collections.singletonList(new EffectInstance(Effects.MINING_FATIGUE,25)),true,16767483),
    HELIUM(0.15f,0.5f,Collections.singletonList(new EffectInstance(Effects.JUMP_BOOST,25)),true,16750204),
    NITROGEN(0.97f,0.19f,Collections.singletonList(new EffectInstance(Effects.NAUSEA,25)),true,14459799),
    ...
    ARGON(1.4f,0.16f,Collections.singletonList(new EffectInstance(Effects.HASTE,25)),true,12354047),
    KRYPTON(2.8f,0.11f,Collections.singletonList(new EffectInstance(Effects.GLOWING,25)),true,12568788),
    XENON(4.5f,0.09f,Collections.singletonList(new EffectInstance(Effects.RESISTANCE,25)),true,8299263),
    ...
    AMMONIA(0.73f,0.24f,Collections.singletonList(new EffectInstance(Effects.NAUSEA,25)),true,14459799),
    CARBON_DIOXIDE(2f,0.15f, Collections.singletonList(new EffectInstance(Effects.MINING_FATIGUE,25)),true,3684408),
