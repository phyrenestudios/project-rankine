package com.cannolicatfish.rankine.client;
...
public class RopeCoilArrowRenderer extends EntityRenderer<RopeCoilArrowEntity> {

    public static final RopeCoilArrowRenderer.RopeCoilArrowRenderFactory instance = new RopeCoilArrowRenderer.RopeCoilArrowRenderFactory();
    public RopeCoilArrowRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public void render(RopeCoilArrowEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
    ...
    @Override
    public ResourceLocation getEntityTexture(RopeCoilArrowEntity entity) {
        return new ResourceLocation("rankine:textures/entity/thorium_arrow.png");
    }
    ...
    public static class RopeCoilArrowRenderFactory implements IRenderFactory<RopeCoilArrowEntity> {
        @Override
        public EntityRenderer<? super RopeCoilArrowEntity> createRenderFor(EntityRendererManager manager) {
            return new RopeCoilArrowRenderer(manager);
        }
