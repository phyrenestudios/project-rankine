...
public class MagnesiumArrowRenderer extends EntityRenderer<MagnesiumArrowEntity> {

    public static final MagnesiumArrowRenderer.MagnesiumArrowRenderFactory instance = new MagnesiumArrowRenderer.MagnesiumArrowRenderFactory();
    public MagnesiumArrowRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public void render(MagnesiumArrowEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(MagnesiumArrowEntity entity) {
        return new ResourceLocation("rankine:textures/entity/magnesium_arrow.png");
    }
    ...
    public static class MagnesiumArrowRenderFactory implements IRenderFactory<MagnesiumArrowEntity> {
        @Override
        public EntityRenderer<? super MagnesiumArrowEntity> createRenderFor(EntityRendererManager manager) {
            return new MagnesiumArrowRenderer(manager);
        }
