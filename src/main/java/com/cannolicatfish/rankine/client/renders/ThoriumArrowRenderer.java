...
public class ThoriumArrowRenderer extends EntityRenderer<ThoriumArrowEntity> {
    ...
    @Override
    public void render(ThoriumArrowEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ThoriumArrowEntity entity) {
    ...
    public static class ThoriumArrowRenderFactory implements IRenderFactory<ThoriumArrowEntity> {
        @Override
        public EntityRenderer<? super ThoriumArrowEntity> createRenderFor(EntityRendererManager manager) {
            return new ThoriumArrowRenderer(manager);
        }
