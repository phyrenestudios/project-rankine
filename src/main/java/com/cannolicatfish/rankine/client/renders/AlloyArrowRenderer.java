...
public class AlloyArrowRenderer extends EntityRenderer<AlloyArrowEntity> {
    ...
    public static final AlloyArrowRenderer.AlloyArrowRenderFactory instance = new AlloyArrowRenderer.AlloyArrowRenderFactory();
    public AlloyArrowRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }

    @Override
    public void render(AlloyArrowEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(AlloyArrowEntity entity) {
        return new ResourceLocation("rankine:textures/entity/alloy_arrow.png");
    }
    ...
    public static class AlloyArrowRenderFactory implements IRenderFactory<AlloyArrowEntity> {
        @Override
        public EntityRenderer<? super AlloyArrowEntity> createRenderFor(EntityRendererManager manager) {
            return new AlloyArrowRenderer(manager);
        }
