...
public class AlloyArrowRenderer extends EntityRenderer<AlloyArrowEntity> {
    ...
    public AlloyArrowRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager);
    }
    ...
    public static class AlloyArrowRenderFactory implements EntityRendererProvider<AlloyArrowEntity> {

        @Override
        public EntityRenderer<AlloyArrowEntity> create(Context p_174010_) {
            return new AlloyArrowRenderer(p_174010_);
        }
    }
