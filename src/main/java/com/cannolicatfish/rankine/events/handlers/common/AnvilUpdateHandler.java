...
public class AnvilUpdateHandler {
    public static void specialEnchants(AnvilUpdateEvent event) {
        ...
        if (event.getRight().getItem() == RankineItems.SANDALS.get() && input.getItem() instanceof ArmorItem && ((ArmorItem)input.getItem()).getType().getSlot() == EquipmentSlot.FEET) {
        ...
        } else if (event.getRight().getItem() == RankineItems.SNOWSHOES.get() && input.getItem() instanceof ArmorItem && ((ArmorItem)input.getItem()).getType().getSlot() == EquipmentSlot.FEET) {
            event.setOutput(input.copy());
        ...
        } else if (event.getRight().getItem() == RankineItems.ICE_SKATES.get() && input.getItem() instanceof ArmorItem && ((ArmorItem)input.getItem()).getType().getSlot() == EquipmentSlot.FEET) {
            event.setOutput(input.copy());
        ...
        } else if (event.getRight().getItem() == RankineItems.GAS_MASK.get() && input.getItem() instanceof ArmorItem && ((ArmorItem)input.getItem()).getType().getSlot() == EquipmentSlot.HEAD) {
            event.setOutput(input.copy());
        ...
        } else if (event.getRight().getItem() == RankineItems.FINS.get() && input.getItem() instanceof ArmorItem && ((ArmorItem)input.getItem()).getType().getSlot() == EquipmentSlot.FEET) {
            event.setOutput(input.copy());
        ...
        } else if (event.getRight().getItem() == RankineItems.GOGGLES.get() && input.getItem() instanceof ArmorItem && ((ArmorItem)input.getItem()).getType().getSlot() == EquipmentSlot.FEET) {
            event.setOutput(input.copy());
