...
public class ModEntityTypes {
    ...
    public static final EntityType<SpearEntity> ROSE_GOLD_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.ROSE_GOLD_SPEAR,4)).size(0.5F, 0.5F),"rose_gold_spear");
    public static final EntityType<SpearEntity> WHITE_GOLD_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.WHITE_GOLD_SPEAR,5)).size(0.5F, 0.5F),"white_gold_spear");
    public static final EntityType<SpearEntity> GREEN_GOLD_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.GREEN_GOLD_SPEAR,6)).size(0.5F, 0.5F),"green_gold_spear");
    public static final EntityType<SpearEntity> BLUE_GOLD_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.BLUE_GOLD_SPEAR,7)).size(0.5F, 0.5F),"blue_gold_spear");
    public static final EntityType<SpearEntity> PURPLE_GOLD_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.PURPLE_GOLD_SPEAR,8)).size(0.5F, 0.5F),"purple_gold_spear");
    public static final EntityType<SpearEntity> AMALGAM_SPEAR = prepareEntity(EntityType.Builder.<SpearEntity>create(EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new SpearEntity(spawnEntity,world,ModEntityTypes.AMALGAM_SPEAR,9)).size(0.5F, 0.5F),"amalgam_spear");
