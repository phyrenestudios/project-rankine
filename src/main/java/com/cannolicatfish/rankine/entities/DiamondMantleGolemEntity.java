...
public class DiamondMantleGolemEntity extends IronGolemEntity {
    ...
    public boolean canAttackType(EntityType<?> typeIn) {
        if (this.isPlayerCreated() && typeIn == EntityType.PLAYER) {
            ...
            return typeIn != RankineEntityTypes.DESMOXYTE && typeIn != RankineEntityTypes.MANTLE_GOLEM && typeIn != RankineEntityTypes.PERIDOT_MANTLE_GOLEM && super.canAttackType(typeIn);
        }
    }
