...
public class JuniperTreeFeature extends Feature<TreeConfiguration> {
    ...
    private void juniperLeaves(WorldGenLevel reader, BlockPos pos, RandomSource rand, TreeConfiguration config) {
    ...
    public static boolean isValidGround(LevelAccessor world, BlockPos pos) {
        return world.getBlockState(pos).canSustainPlant(world, pos, Direction.UP, RankineBlocks.JUNIPER.getSapling());
    }
}
