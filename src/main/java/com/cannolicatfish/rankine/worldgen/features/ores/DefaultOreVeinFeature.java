package com.cannolicatfish.rankine.worldgen.features.ores;
                            ...
                            for(int j2 = l; j2 <= k1; ++j2) {
                                ...
                                if (d5 * d5 + d6 * d6 < 1.0D) {
                                    for(int k2 = i1; k2 <= l1; ++k2) {
                                        ...
                                        if (d5 * d5 + d6 * d6 + d7 * d7 < 1.0D && !levelIn.isOutsideBuildHeight(j2)) {
                                            int l2 = i2 - p_66542_ + (j2 - p_66543_) * p_66545_ + (k2 - p_66544_) * p_66545_ * p_66546_;
                                            if (!bitset.get(l2)) {
                                                bitset.set(l2);
                                                blockpos$mutableblockpos.set(i2, j2, k2);
                                                if (levelIn.ensureCanWrite(blockpos$mutableblockpos)) {
