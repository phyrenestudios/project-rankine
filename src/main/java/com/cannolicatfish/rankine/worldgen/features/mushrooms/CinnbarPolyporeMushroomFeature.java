...
public class CinnbarPolyporeMushroomFeature extends AbstractWallMushroomFeature {
    ...
    protected List<BlockPos> validDir(WorldGenLevel levelIn, BlockPos pos) {
        for (Direction dir : Direction.values()) {
            ...
            List<BlockPos> blockList = Arrays.asList(pos, pos.relative(dir.getCounterClockWise()), pos.relative(dir.getClockWise()), pos.relative(dir));
