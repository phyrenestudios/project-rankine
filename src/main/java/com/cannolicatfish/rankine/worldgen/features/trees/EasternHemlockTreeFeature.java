...
public class EasternHemlockTreeFeature extends Feature<TreeConfiguration> {
    ...
    public EasternHemlockTreeFeature(Codec<TreeConfiguration> config) {
        super(config);
    }
    ...
    public static boolean isValidGround(LevelAccessor world, BlockPos pos) {
        return world.getBlockState(pos).canSustainPlant(world, pos, Direction.UP, RankineBlocks.EASTERN_HEMLOCK.getSapling());
    }
}
