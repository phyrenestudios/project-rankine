...
public class PistonCrusherScreen extends AbstractContainerScreen<PistonCrusherContainer> {
    private ResourceLocation GUI = new ResourceLocation(ProjectRankine.MODID, "textures/gui/piston_crusher.png");
    public PistonCrusherScreen(PistonCrusherContainer container, Inventory inv, Component name) {
