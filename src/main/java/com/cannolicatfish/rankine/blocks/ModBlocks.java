...
public class ModBlocks {
    ...
    public static final Block BASALT_BRICKS = add("basalt_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2).harvestLevel(2)), MAIN);
    public static final Block RHYOLITE = add("rhyolite", new RankineStone(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block RHYOLITE_BRICKS = add("rhyolite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MARBLE = add("marble", new RankineStone(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block GNEISS = add("gneiss", new RankineStone(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block ANORTHOSITE = add("anorthosite", new RankineStone(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_ANORTHOSITE = add("smooth_anorthosite", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block ANORTHOSITE_BRICKS = add("anorthosite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    ...
    public static final Block PUMICE = add("pumice", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_PUMICE = add("smooth_pumice", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PUMICE_BRICKS = add("pumice_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA = add("scoria", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_SCORIA = add("smooth_scoria", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_BRICKS = add("scoria_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    ...
    public static final Block PERIDOTITE_BRICKS = add("peridotite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block RINGWOODITE_BRICKS = add("ringwoodite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block WADSLEYITE_BRICKS = add("wadsleyite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block BRIDGMANITE_BRICKS = add("bridgmanite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block KOMATIITE_BRICKS = add("komatiite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block KIMBERLITE_BRICKS = add("kimberlite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block FERROPERICLASE_BRICKS = add("ferropericlase_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block PEROVSKITE_BRICKS = add("perovskite_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block CLAY_BRICKS = add("clay_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block REFRACTORY_BRICKS = add("refractory_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MAGNESIUM_REFRACTORY_BRICKS = add("magnesium_refractory_bricks", new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block BASALT_SLAB = add("basalt_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_BASALT_SLAB = add("smooth_basalt_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(2)), MAIN);
    public static final Block BASALT_BRICKS_SLAB = add("basalt_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RHYOLITE_SLAB = add("rhyolite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_RHYOLITE_SLAB = add("smooth_rhyolite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(2)), MAIN);
    public static final Block RHYOLITE_BRICKS_SLAB = add("rhyolite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MARBLE_SLAB = add("marble_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_MARBLE_SLAB = add("smooth_marble_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(2)), MAIN);
    public static final Block MARBLE_BRICKS_SLAB = add("marble_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block GNEISS_SLAB = add("gneiss_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_GNEISS_SLAB = add("smooth_gneiss_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(2)), MAIN);
    public static final Block GNEISS_BRICKS_SLAB = add("gneiss_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block ANORTHOSITE_SLAB = add("anorthosite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_ANORTHOSITE_SLAB = add("smooth_anorthosite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block ANORTHOSITE_BRICKS_SLAB = add("anorthosite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block IRONSTONE_SLAB = add("ironstone_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_IRONSTONE_SLAB = add("smooth_ironstone_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block IRONSTONE_BRICKS_SLAB = add("ironstone_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PUMICE_SLAB = add("pumice_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_PUMICE_SLAB = add("smooth_pumice_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PUMICE_BRICKS_SLAB = add("pumice_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_SLAB = add("scoria_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_SCORIA_SLAB = add("smooth_scoria_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_BRICKS_SLAB = add("scoria_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PERIDOTITE_SLAB = add("peridotite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_PERIDOTITE_SLAB = add("smooth_peridotite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block PERIDOTITE_BRICKS_SLAB = add("peridotite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RINGWOODITE_SLAB = add("ringwoodite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_RINGWOODITE_SLAB = add("smooth_ringwoodite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block RINGWOODITE_BRICKS_SLAB = add("ringwoodite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block WADSLEYITE_SLAB = add("wadsleyite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_WADSLEYITE_SLAB = add("smooth_wadsleyite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block WADSLEYITE_BRICKS_SLAB = add("wadsleyite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block BRIDGMANITE_SLAB = add("bridgmanite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_BRIDGMANITE_SLAB = add("smooth_bridgmanite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block BRIDGMANITE_BRICKS_SLAB = add("bridgmanite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KOMATIITE_SLAB = add("komatiite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_KOMATIITE_SLAB = add("smooth_komatiite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block KOMATIITE_BRICKS_SLAB = add("komatiite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KIMBERLITE_SLAB = add("kimberlite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_KIMBERLITE_SLAB = add("smooth_kimberlite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block KIMBERLITE_BRICKS_SLAB = add("kimberlite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block FERROPERICLASE_SLAB = add("ferropericlase_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_FERROPERICLASE_SLAB = add("smooth_ferropericlase_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block FERROPERICLASE_BRICKS_SLAB = add("ferropericlase_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PEROVSKITE_SLAB = add("perovskite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_PEROVSKITE_SLAB = add("smooth_perovskite_slab", new RankineSlab(Block.Properties.create(Material.ROCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2).harvestLevel(3)), MAIN);
    public static final Block PEROVSKITE_BRICKS_SLAB = add("perovskite_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block CLAY_BRICKS_SLAB = add("clay_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block REFRACTORY_BRICKS_SLAB = add("refractory_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MAGNESIUM_REFRACTORY_BRICKS_SLAB = add("magnesium_refractory_bricks_slab", new RankineSlab(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block BASALT_STAIRS = add("basalt_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block BASALT_BRICKS_STAIRS = add("basalt_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RHYOLITE_STAIRS = add("rhyolite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block RHYOLITE_BRICKS_STAIRS = add("rhyolite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MARBLE_STAIRS = add("marble_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block MARBLE_BRICKS_STAIRS = add("marble_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block GNEISS_STAIRS = add("gneiss_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block GNEISS_BRICKS_STAIRS = add("gneiss_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block SMOOTH_SHALE_STAIRS = add("smooth_shale_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    ...
    public static final Block ANORTHOSITE_STAIRS = add("anorthosite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_ANORTHOSITE_STAIRS = add("smooth_anorthosite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block ANORTHOSITE_BRICKS_STAIRS = add("anorthosite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block IRONSTONE_STAIRS = add("ironstone_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_IRONSTONE_STAIRS = add("smooth_ironstone_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block IRONSTONE_BRICKS_STAIRS = add("ironstone_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PUMICE_STAIRS = add("pumice_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_PUMICE_STAIRS = add("smooth_pumice_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PUMICE_BRICKS_STAIRS = add("pumice_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_STAIRS = add("scoria_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_SCORIA_STAIRS = add("smooth_scoria_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_BRICKS_STAIRS = add("scoria_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PERIDOTITE_STAIRS = add("peridotite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_PERIDOTITE_STAIRS = add("smooth_peridotite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block PERIDOTITE_BRICKS_STAIRS = add("peridotite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RINGWOODITE_STAIRS = add("ringwoodite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_RINGWOODITE_STAIRS = add("smooth_ringwoodite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block RINGWOODITE_BRICKS_STAIRS = add("ringwoodite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block WADSLEYITE_STAIRS = add("wadsleyite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_WADSLEYITE_STAIRS = add("smooth_wadsleyite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block WADSLEYITE_BRICKS_STAIRS = add("wadsleyite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block BRIDGMANITE_STAIRS = add("bridgmanite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_BRIDGMANITE_STAIRS = add("smooth_bridgmanite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block BRIDGMANITE_BRICKS_STAIRS = add("bridgmanite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KOMATIITE_STAIRS = add("komatiite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_KOMATIITE_STAIRS = add("smooth_komatiite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block KOMATIITE_BRICKS_STAIRS = add("komatiite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KIMBERLITE_STAIRS = add("kimberlite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_KIMBERLITE_STAIRS = add("smooth_kimberlite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block KIMBERLITE_BRICKS_STAIRS = add("kimberlite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block FERROPERICLASE_STAIRS = add("ferropericlase_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_FERROPERICLASE_STAIRS = add("smooth_ferropericlase_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block FERROPERICLASE_BRICKS_STAIRS = add("ferropericlase_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PEROVSKITE_STAIRS = add("perovskite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_PEROVSKITE_STAIRS = add("smooth_perovskite_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(2.0F, 3.0F)), MAIN);
    public static final Block PEROVSKITE_BRICKS_STAIRS = add("perovskite_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block CLAY_BRICKS_STAIRS = add("clay_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block REFRACTORY_BRICKS_STAIRS = add("refractory_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MAGNESIUM_REFRACTORY_BRICKS_STAIRS = add("magnesium_refractory_bricks_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block BASALT_WALL = add("basalt_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_BASALT_WALL = add("smooth_basalt_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block BASALT_BRICKS_WALL = add("basalt_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RHYOLITE_WALL = add("rhyolite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_RHYOLITE_WALL = add("smooth_rhyolite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RHYOLITE_BRICKS_WALL = add("rhyolite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MARBLE_WALL = add("marble_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_MARBLE_WALL = add("smooth_marble_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block MARBLE_BRICKS_WALL = add("marble_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block GNEISS_WALL = add("gneiss_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_GNEISS_WALL = add("smooth_gneiss_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block GNEISS_BRICKS_WALL = add("gneiss_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(2).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block ANORTHOSITE_WALL = add("anorthosite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_ANORTHOSITE_WALL = add("smooth_anorthosite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block ANORTHOSITE_BRICKS_WALL = add("anorthosite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block IRONSTONE_WALL = add("ironstone_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_IRONSTONE_WALL = add("smooth_ironstone_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block IRONSTONE_BRICKS_WALL = add("ironstone_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(1).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PUMICE_WALL = add("pumice_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_PUMICE_WALL = add("smooth_pumice_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PUMICE_BRICKS_WALL = add("pumice_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_WALL = add("scoria_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SMOOTH_SCORIA_WALL = add("smooth_scoria_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block SCORIA_BRICKS_WALL = add("scoria_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1.5F, 6.0F).harvestLevel(0)), MAIN);
    public static final Block PERIDOTITE_WALL = add("peridotite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_PERIDOTITE_WALL = add("smooth_peridotite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PERIDOTITE_BRICKS_WALL = add("peridotite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RINGWOODITE_WALL = add("ringwoodite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_RINGWOODITE_WALL = add("smooth_ringwoodite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block RINGWOODITE_BRICKS_WALL = add("ringwoodite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block WADSLEYITE_WALL = add("wadsleyite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_WADSLEYITE_WALL = add("smooth_wadsleyite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block WADSLEYITE_BRICKS_WALL = add("wadsleyite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block BRIDGMANITE_WALL = add("bridgmanite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_BRIDGMANITE_WALL = add("smooth_bridgmanite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block BRIDGMANITE_BRICKS_WALL = add("bridgmanite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KOMATIITE_WALL = add("komatiite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_KOMATIITE_WALL = add("smooth_komatiite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KOMATIITE_BRICKS_WALL = add("komatiite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KIMBERLITE_WALL = add("kimberlite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_KIMBERLITE_WALL = add("smooth_kimberlite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block KIMBERLITE_BRICKS_WALL = add("kimberlite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block FERROPERICLASE_WALL = add("ferropericlase_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_FERROPERICLASE_WALL = add("smooth_ferropericlase_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block FERROPERICLASE_BRICKS_WALL = add("ferropericlase_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PEROVSKITE_WALL = add("perovskite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block SMOOTH_PEROVSKITE_WALL = add("smooth_perovskite_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    public static final Block PEROVSKITE_BRICKS_WALL = add("perovskite_bricks_wall", new RankineWall(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.0F, 2.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)), MAIN);
    ...
    public static final Block BAMBOO_PLANKS = add("bamboo_planks", new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F).harvestLevel(0).harvestTool(ToolType.AXE)), MAIN, 900);
    public static final Block BAMBOO_CLUMS = add("bamboo_clums", new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F).harvestLevel(0).harvestTool(ToolType.AXE)), MAIN, 900);
    ...
    public static final Block BAMBOO_CLUMS_SLAB = add("bamboo_clums_slab", new RankineSlab(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F).harvestLevel(0).harvestTool(ToolType.AXE)), MAIN);
    ...
    public static final Block BAMBOO_CLUMS_STAIRS = add("bamboo_clums_stairs", new RankineStairs(Block.getStateById(0),Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F).harvestLevel(0).harvestTool(ToolType.AXE)), MAIN);

    public static final Block CEDAR_FENCE = add("cedar_fence", new RankineWoodenFence(), MAIN);
    public static final Block PINYON_PINE_FENCE = add("pinyon_pine_fence", new RankineWoodenFence(), MAIN);
    public static final Block JUNIPER_FENCE = add("juniper_fence", new RankineWoodenFence(), MAIN);
    public static final Block COCONUT_PALM_FENCE = add("coconut_palm_fence", new RankineWoodenFence(), MAIN);
    public static final Block BALSAM_FIR_FENCE = add("balsam_fir_fence", new RankineWoodenFence(), MAIN);
    public static final Block MAGNOLIA_FENCE = add("magnolia_fence", new RankineWoodenFence(), MAIN);
    public static final Block BAMBOO_FENCE = add("bamboo_fence", new RankineWoodenFence(), MAIN);
    public static final Block BAMBOO_CLUMS_FENCE = add("bamboo_clums_fence", new RankineWoodenFence(), MAIN);

    public static final Block CEDAR_FENCE_GATE = add("cedar_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block PINYON_PINE_FENCE_GATE = add("pinyon_pine_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block JUNIPER_FENCE_GATE = add("juniper_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block COCONUT_PALM_FENCE_GATE = add("coconut_palm_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block BALSAM_FIR_FENCE_GATE = add("balsam_fir_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block MAGNOLIA_FENCE_GATE = add("magnolia_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block BAMBOO_FENCE_GATE = add("bamboo_fence_gate", new RankineWoodenFenceGate(), MAIN);
    public static final Block BAMBOO_CLUMS_FENCE_GATE = add("bamboo_clums_fence_gate", new RankineWoodenFenceGate(), MAIN);

    public static final Block BAMBOO_WALL = add("bamboo_wall", new RankineWall(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F).harvestLevel(0).harvestTool(ToolType.AXE)), MAIN);
    public static final Block BAMBOO_CLUMS_WALL = add("bamboo_clums_wall", new RankineWall(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F).harvestLevel(0).harvestTool(ToolType.AXE)), MAIN);

    public static final Block CEDAR_PRESSURE_PLATE = add("cedar_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block PINYON_PINE_PRESSURE_PLATE = add("pinyon_pine_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block JUNIPER_PRESSURE_PLATE = add("juniper_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block COCONUT_PALM_PRESSURE_PLATE = add("coconut_palm_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block BALSAM_FIR_PRESSURE_PLATE = add("balsam_fir_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block MAGNOLIA_PRESSURE_PLATE = add("magnolia_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block BAMBOO_PRESSURE_PLATE = add("bamboo_pressure_plate", new RankineWoodenPressurePlate(), MAIN);
    public static final Block BAMBOO_CLUMS_PRESSURE_PLATE = add("bamboo_clums_pressure_plate", new RankineWoodenPressurePlate(), MAIN);

    public static final Block CEDAR_BUTTON = add("cedar_button", new RankineWoodenButton(), MAIN);
    public static final Block PINYON_PINE_BUTTON = add("pinyon_pine_button", new RankineWoodenButton(), MAIN);
    public static final Block JUNIPER_BUTTON = add("juniper_button", new RankineWoodenButton(), MAIN);
    public static final Block COCONUT_PALM_BUTTON = add("coconut_palm_button", new RankineWoodenButton(), MAIN);
    public static final Block BALSAM_FIR_BUTTON = add("balsam_fir_button", new RankineWoodenButton(), MAIN);
    public static final Block MAGNOLIA_BUTTON = add("magnolia_button", new RankineWoodenButton(), MAIN);
    public static final Block BAMBOO_BUTTON = add("bamboo_button", new RankineWoodenButton(), MAIN);
    public static final Block BAMBOO_CLUMS_BUTTON = add("bamboo_clums_button", new RankineWoodenButton(), MAIN);

    public static final Block CEDAR_DOOR = add("cedar_door", new RankineWoodenDoor(), MAIN);
    public static final Block PINYON_PINE_DOOR = add("pinyon_pine_door", new RankineWoodenDoor(), MAIN);
    public static final Block JUNIPER_DOOR = add("juniper_door", new RankineWoodenDoor(), MAIN);
    public static final Block COCONUT_PALM_DOOR = add("coconut_palm_door", new RankineWoodenDoor(), MAIN);
    public static final Block BALSAM_FIR_DOOR = add("balsam_fir_door", new RankineWoodenDoor(), MAIN);
    public static final Block MAGNOLIA_DOOR = add("magnolia_door", new RankineWoodenDoor(), MAIN);

    public static final Block CEDAR_TRAPDOOR = add("cedar_trapdoor", new RankineWoodenTrapDoor(), MAIN);
    public static final Block PINYON_PINE_TRAPDOOR = add("pinyon_pine_trapdoor", new RankineWoodenTrapDoor(), MAIN);
    public static final Block JUNIPER_TRAPDOOR = add("juniper_trapdoor", new RankineWoodenTrapDoor(), MAIN);
    public static final Block COCONUT_PALM_TRAPDOOR = add("coconut_palm_trapdoor", new RankineWoodenTrapDoor(), MAIN);
    public static final Block BALSAM_FIR_TRAPDOOR = add("balsam_fir_trapdoor", new RankineWoodenTrapDoor(), MAIN);
    public static final Block MAGNOLIA_TRAPDOOR = add("magnolia_trapdoor", new RankineWoodenTrapDoor(), MAIN);
