...
public class CedarTree extends Tree {
    ...
    public CedarTree(LogBlock log, LeavesBlock leaf, SaplingBlock sapling) {
        this.log = log;
        this.leaf = leaf;
    ...
    protected ConfiguredFeature<TreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean p_225546_2_) {
        return new TreeFeature(TreeFeatureConfig::func_227338_a_).withConfiguration(ModBiomeFeatures.CEDAR_TREE_CONFIG);
    }
}
