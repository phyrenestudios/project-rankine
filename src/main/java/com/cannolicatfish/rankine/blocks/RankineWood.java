...
public class RankineWood {
    ...
    public static RankineWood newWoodReg(String baseName, float strength, boolean hasLogs) {
        ...
        if (newWood.hasLogs) {
            RankineItems.ITEMS.register(baseName + "_log", () -> new BlockItem(newWood.log.get(), DEF_BUILDING));
            RankineItems.ITEMS.register("stripped_" + baseName + "_log", () -> new BlockItem(newWood.strippedLog.get(), DEF_BUILDING));
            RankineItems.ITEMS.register(baseName + "_wood", () -> new BlockItem(newWood.wood.get(), DEF_BUILDING));
            RankineItems.ITEMS.register("stripped_" + baseName + "_wood", () -> new BlockItem(newWood.strippedWood.get(), DEF_BUILDING));
        }
        if (newWood.getBaseName().equals("bamboo_culms")) {
            RankineItems.ITEMS.register(baseName, () -> new BlockItem(newWood.planks.get(), DEF_BUILDING));
        } else {
            RankineItems.ITEMS.register(baseName+"_planks", () -> new BuildingModeBlockItem(newWood.planks.get(), DEF_BUILDING));
        }
        RankineItems.ITEMS.register(baseName+"_slab", () -> new BlockItem(newWood.slab.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_stairs", () -> new BlockItem(newWood.stairs.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_fence", () -> new BlockItem(newWood.fence.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_fence_gate", () -> new BlockItem(newWood.fenceGate.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_door", () -> new BlockItem(newWood.door.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_trapdoor", () -> new BlockItem(newWood.trapdoor.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_pressure_plate", () -> new BlockItem(newWood.pressurePlate.get(), DEF_BUILDING));
        RankineItems.ITEMS.register(baseName+"_button", () -> new BlockItem(newWood.button.get(), DEF_BUILDING));
        newWood.signItem = RankineItems.ITEMS.register(baseName+"_sign", () -> new SignItem(new Item.Properties().stacksTo(16).tab(ProjectRankine.setup.rankineWorld),newWood.sign.get(),newWood.wallSign.get()));
        RankineItems.ITEMS.register(baseName+"_bookshelf", () -> new BuildingModeBlockItem(newWood.bookshelf.get(), DEF_BUILDING));
        newWood.boat = RankineItems.ITEMS.register(baseName+"_boat", () -> new RankineBoatItem(RankineBoatEntity.Type.getTypeFromString(baseName), new Item.Properties().stacksTo(1).tab(ProjectRankine.setup.rankineTools)));
