    ...
    private boolean canSmelt()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                AlloyItem.addAlloy(result,new AlloyData(AlloyingRecipesComplex.getInstance().getComposition(this.handler2.getStackInSlot(0), (ItemStack)this.handler2.getStackInSlot(1), (ItemStack)this.handler2.getStackInSlot(2))));
