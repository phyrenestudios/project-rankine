...
public class RankineStone {
    ...
    public static RankineStone newStoneReg(String baseName, String stoneCLass) {
        ...
        RankineBlocks.ITEMS.register("mossy_"+baseName+"_bricks", () -> new BuildingModeBlockItem(newStone.mossyBricks.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_slab", () -> new BlockItem(newStone.slab.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("polished_"+baseName+"_slab", () -> new BlockItem(newStone.polishedSLab.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_bricks"+"_slab", () -> new BlockItem(newStone.bricksSlab.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("mossy_"+baseName+"_bricks"+"_slab", () -> new BlockItem(newStone.mossyBricksSlab.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_stairs", () -> new BlockItem(newStone.stairs.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("polished_"+baseName+"_stairs", () -> new BlockItem(newStone.polishedStairs.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_bricks"+"_stairs", () -> new BlockItem(newStone.bricksStairs.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("mossy_"+baseName+"_bricks"+"_stairs", () -> new BlockItem(newStone.mossyBricksStairs.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_wall", () -> new BlockItem(newStone.wall.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("polished_"+baseName+"_wall", () -> new BlockItem(newStone.polishedWall.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_bricks"+"_wall", () -> new BlockItem(newStone.bricksWall.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("mossy_"+baseName+"_bricks"+"_wall", () -> new BlockItem(newStone.mossyBricksWall.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_pressure_plate", () -> new BlockItem(newStone.pressurePlate.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_bricks"+"_pressure_plate", () -> new BlockItem(newStone.bricksPressurePlate.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_button", () -> new BlockItem(newStone.button.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_column", () -> new BlockItem(newStone.column.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register(baseName+"_cobble", () -> new BlockItem(newStone.cobble.get(), DEF_BUILDING));
        RankineBlocks.ITEMS.register("infested_"+baseName, () -> new BlockItem(newStone.infested.get(), DEF_BUILDING));
