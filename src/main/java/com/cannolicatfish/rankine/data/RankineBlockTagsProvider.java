...
public class RankineBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(RankineTags.Blocks.MINEABLE_WITH_CROWBAR).addTags(RankineTags.Blocks.SHEETMETAL,RankineTags.Blocks.SHEETMETAL_SALBS,RankineTags.Blocks.SHEETMETAL_VERTICAL_SALBS,BlockTags.PLANKS,BlockTags.WOODEN_SLABS,BlockTags.WOODEN_STAIRS,BlockTags.WOODEN_DOORS,BlockTags.WOODEN_TRAPDOORS,BlockTags.WOODEN_FENCES,BlockTags.FENCE_GATES,BlockTags.RAILS,RankineTags.Blocks.METAL_BARS).add(RankineBlocks.STUMP.get());
