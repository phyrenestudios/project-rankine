...
public class RankineRecipesProvider extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(RankineItems.WOODEN_MALLET.get(), 1).patternLine("PPP").patternLine("PPP").patternLine(" S ").key('P', ItemTags.PLANKS).key('S', Tags.Items.RODS_WOODEN).addCriterion("has_ingredient", hasItem(ItemTags.PLANKS)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(RankineItems.STONE_MALLET.get(), 1).patternLine("PPP").patternLine("PPP").patternLine(" S ").key('P', Tags.Items.COBBLESTONE).key('S', Tags.Items.RODS_WOODEN).addCriterion("has_ingredient", hasItem(Tags.Items.COBBLESTONE)).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(RankineItems.TOTEM_OF_ENDURING.get(), 1).patternLine("III").patternLine("IRI").patternLine("III").key('I', RankineTags.Items.INGOTS_BLUE_GOLD).key('R', RankineTags.Items.STORAGE_BLOCKS_AQUAMARINE).addCriterion("has_ingredient", hasItem(RankineTags.Items.INGOTS_BLUE_GOLD)).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(RankineBlocks.MIXING_BARREL.get(), 1).patternLine("L").patternLine("B").patternLine("S").key('B', Blocks.BARREL).key('S', RankineTags.Items.STONE_SLAB).key('L', Items.LEVER).addCriterion("has_ingredient", hasItem(Items.BARREL)).build(consumer);
