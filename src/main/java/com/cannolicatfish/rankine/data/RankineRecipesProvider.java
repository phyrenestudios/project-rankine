...
public class RankineRecipesProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(Items.PAINTING, 1).pattern("SSS").pattern("SMS").pattern("SSS").define('M', RankineItems.ARTIST_CONK_MUSHROOM.get()).define('S', Tags.Items.RODS_WOODEN).unlockedBy("has_ingredient", has(RankineItems.ARTIST_CONK_MUSHROOM.get())).save(consumer, "rankine:painting_from_mushroom");
        ...
        for (Block BLOCK : RankineLists.MISC_BLOCKS) {
            ...
            RecipeProvider.slab(consumer,SLAB.asItem(),BLOCK.asItem());
        ...
        ShapedRecipeBuilder.shaped(Items.BREAD,  1).pattern("###").define('#', RankineItems.SORGHUM.get()).group("gf_bread").unlockedBy("has_ingredient", has(RankineItems.SORGHUM.get())).save(consumer,"rankine:bread_from_sorghum");
        ...
        ShapedRecipeBuilder.shaped(RankineBlocks.KAOLINITE_BLOCK.get(), 1).pattern("##").pattern("##").define('#', RankineItems.KAOLINITE.get()).unlockedBy("has_ingredient", has(RankineItems.KAOLINITE.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.HALLOYSITE_BLOCK.get(), 1).pattern("##").pattern("##").define('#', RankineItems.HALLOYSITE.get()).unlockedBy("has_ingredient", has(RankineItems.HALLOYSITE.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RankineItems.TOTEM_OF_POWERING.get(), 1).pattern("III").pattern("IRI").pattern("III").define('I', RankineTags.Items.INGOTS_NEPTUNIUM_ALLOY).define('R', Items.CONDUIT).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_NEPTUNIUM_ALLOY)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RankineItems.WOOD_TIER_MINING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.STONECUTTER).define('B', RankineTags.Items.STORAGE_BLOCKS_ROSE_METAL).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_ROSE_METAL)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.STONE_TIER_MINING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.STONECUTTER).define('B', RankineTags.Items.STORAGE_BLOCKS_BRASS).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_BRASS)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.IRON_TIER_MINING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.STONECUTTER).define('B', RankineTags.Items.STORAGE_BLOCKS_STEEL).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_STEEL)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.DIAMOND_TIER_MINING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.STONECUTTER).define('B', RankineTags.Items.STORAGE_BLOCKS_TITANIUM_ALLOY).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_TITANIUM_ALLOY)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.NETHERITE_TIER_MINING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.STONECUTTER).define('B', RankineTags.Items.STORAGE_BLOCKS_TUNGSTEN_HEAVY_ALLOY).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_TUNGSTEN_HEAVY_ALLOY)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.WOOD_TIER_CRUSHING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.GRINDSTONE).define('B', RankineTags.Items.STORAGE_BLOCKS_ROSE_METAL).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_ROSE_METAL)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.STONE_TIER_CRUSHING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.GRINDSTONE).define('B', RankineTags.Items.STORAGE_BLOCKS_BRASS).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_BRASS)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.IRON_TIER_CRUSHING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.GRINDSTONE).define('B', RankineTags.Items.STORAGE_BLOCKS_STEEL).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_STEEL)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.DIAMOND_TIER_CRUSHING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.GRINDSTONE).define('B', RankineTags.Items.STORAGE_BLOCKS_TITANIUM_ALLOY).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_TITANIUM_ALLOY)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.NETHERITE_TIER_CRUSHING_HEAD.get(), 1).pattern(" G ").pattern("GBG").pattern("SSS").define('S', ItemTags.STONE_BRICKS).define('G', Items.GRINDSTONE).define('B', RankineTags.Items.STORAGE_BLOCKS_TUNGSTEN_HEAVY_ALLOY).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_TUNGSTEN_HEAVY_ALLOY)).save(consumer);
        ...
        //Machines
        ShapedRecipeBuilder.shaped(RankineBlocks.BEEHIVE_OVEN_PIT.get(), 1).pattern(" S ").pattern("SLS").pattern(" S ").define('S', RankineBlocks.REFRACTORY_BRICKS.getBricksBlock()).define('L', Tags.Items.STORAGE_BLOCKS_COAL).unlockedBy("has_ingredient", has(RankineBlocks.REFRACTORY_BRICKS.getBricksBlock())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.ALLOY_FURNACE.get(), 1).pattern("BSB").pattern("BSB").pattern("BCB").define('B', RankineBlocks.REFRACTORY_BRICKS.getBricksBlock()).define('S', RankineTags.Items.SHEETMETAL).define('C', RankineTags.Items.CAMPFIRES).unlockedBy("has_ingredient", has(RankineBlocks.REFRACTORY_BRICKS.getBricksBlock())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RankineBlocks.BATTERY_CHARGER.get(), 1).pattern("XSX").pattern("R R").pattern("XSX").define('X', RankineTags.Items.SHEETMETAL).define('R', Items.REPEATER).define('S', RankineTags.Items.SHEETMETAL).unlockedBy("has_ingredient", has(RankineTags.Items.INGOTS_MAGNESIUM_ALLOY)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RankineBlocks.CRUCIBLE_BLOCK.get(), 1).pattern("R R").pattern("R R").pattern("RCR").define('R', RankineBlocks.HIGH_REFRACTORY_BRICKS.getBricksBlock()).define('C', Items.CAULDRON).unlockedBy("has_ingredient", has(RankineBlocks.HIGH_REFRACTORY_BRICKS.getBricksBlock())).save(consumer);
        ...
        stonecutterResultFromBase(consumer, RankineItems.REFRACTORY_BRICK.get(), RankineBlocks.REFRACTORY_BRICKS.getBricksBlock(), 2);
        stonecutterResultFromBase(consumer, RankineItems.HIGH_REFRACTORY_BRICK.get(), RankineBlocks.HIGH_REFRACTORY_BRICKS.getBricksBlock(), 2);
        stonecutterResultFromBase(consumer, RankineItems.ULTRA_HIGH_REFRACTORY_BRICK.get(), RankineBlocks.ULTRA_HIGH_REFRACTORY_BRICKS.getBricksBlock(), 2);
        ...
        for (RankineWood Wood : RankineLists.RANKINE_WOODS) {
            ...
            ShapedRecipeBuilder.shaped(Wood.getSignItem(), 3).pattern("###").pattern("###").pattern(" S ").define('#', Wood.getPlanks()).define('S', Tags.Items.RODS_WOODEN).group("sign").unlockedBy("has_ingredient", InventoryChangeTrigger.TriggerInstance.hasItems(Wood.getPlanks())).save(consumer);
            ShapelessRecipeBuilder.shapeless(Wood.getButton()).requires(PLANK).group("wooden_button").unlockedBy("has_ingredient", has(PLANK)).save(consumer);

            ShapelessRecipeBuilder.shapeless(PLANK).requires(Wood.getSlab()).requires(Wood.getSlab()).group("block_from_vslab").unlockedBy("has_ingredient", has(PLANK)).save(consumer,"rankine:"+Wood.getBaseName()+"_from_slab");
            ShapelessRecipeBuilder.shapeless(PLANK,3).requires(Wood.getStairs()).requires(Wood.getStairs()).requires(Wood.getStairs()).requires(Wood.getStairs()).group("block_from_stairs").unlockedBy("has_ingredient", has(PLANK)).save(consumer,"rankine:"+Wood.getBaseName()+"_from_stairs");

            if (Wood.getBaseName().equals("bamboo")) {
                ShapedRecipeBuilder.shaped(Wood.getPlanks(), 1).pattern("##").pattern("##").define('#', RankineItems.DRIED_BAMBOO.get()).unlockedBy("has_ingredient", has(RankineItems.DRIED_BAMBOO.get())).save(consumer);
            } else if (Wood.getBaseName().equals("bamboo_culms")) {
                ShapedRecipeBuilder.shaped(Wood.getPlanks(), 1).pattern("##").pattern("##").define('#', Items.BAMBOO).unlockedBy("has_ingredient", has(Items.BAMBOO)).save(consumer);
            }
        ...
        for (RankineBricks Bricks : RankineLists.RANKINE_BRICKS) {
            Block BRICKS = Bricks.getBricksBlock();
            slab(consumer, Bricks.getBricksSlab(), BRICKS, "bricks_slab");
            stairs(consumer, Bricks.getBricksStairs(), BRICKS, "bricks_stairs");
            wall(consumer, Bricks.getBricksWall(), BRICKS, "bricks_wall");
            stonecutterResultFromBase(consumer, Bricks.getBricksSlab(), BRICKS, 2);
            stonecutterResultFromBase(consumer, Bricks.getBricksStairs(), BRICKS);
            stonecutterResultFromBase(consumer, Bricks.getBricksWall(), BRICKS);
            slabReconstruct(consumer, Bricks.getBricksSlab(), BRICKS);
            stairsReconstruct(consumer, Bricks.getBricksStairs(), BRICKS);
        }
        ShapedRecipeBuilder.shaped(RankineBlocks.CLAY_BRICKS.getBricksBlock()).define('#', Items.CLAY_BALL).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_clay", has(Items.CLAY_BALL)).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.KAOLINITE_CLAY_BRICKS.getBricksBlock()).define('#', RankineItems.KAOLINITE.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_clay", has(RankineItems.KAOLINITE.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.HALLOYSITE_BRICKS.getBricksBlock()).define('#', RankineItems.HALLOYSITE.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_clay", has(RankineItems.HALLOYSITE.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.FIRE_CLAY_BRICKS.getBricksBlock()).define('#', RankineItems.FIRE_CLAY_BALL.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_clay", has(RankineItems.FIRE_CLAY_BALL.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.PORCELAIN_CLAY_BRICKS.getBricksBlock()).define('#', RankineItems.PORCELAIN_CLAY_BALL.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_clay", has(RankineItems.PORCELAIN_CLAY_BALL.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.REFRACTORY_BRICKS.getBricksBlock()).define('#', RankineItems.REFRACTORY_BRICK.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_refractory_brick", has(RankineItems.REFRACTORY_BRICK.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.HIGH_REFRACTORY_BRICKS.getBricksBlock()).define('#', RankineItems.HIGH_REFRACTORY_BRICK.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_high_refractory_brick", has(RankineItems.HIGH_REFRACTORY_BRICK.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineBlocks.ULTRA_HIGH_REFRACTORY_BRICKS.getBricksBlock()).define('#', RankineItems.ULTRA_HIGH_REFRACTORY_BRICK.get()).define('M', RankineItems.MORTAR.get()).pattern("#M").pattern("M#").unlockedBy("has_refractory_brick", has(RankineItems.ULTRA_HIGH_REFRACTORY_BRICK.get())).save(consumer);
        ...
        SimpleCookingRecipeBuilder.cooking(Ingredient.of(RankineItems.TINDER_CONK_MUSHROOM.get()), RankineItems.SMOULDERING_TINDER_CONK.get(), 0.35F, 200, RecipeSerializer.CAMPFIRE_COOKING_RECIPE).unlockedBy("has_ingredient", has(RankineItems.TINDER_CONK_MUSHROOM.get())).save(consumer, "rankine:smouldering_tinder_conk_cooking");
        //Smoking
        ...
        SimpleCookingRecipeBuilder.cooking(Ingredient.of(RankineItems.TOFU.get()), RankineItems.COOKED_TOFU.get(), 0.35F, 100, RecipeSerializer.SMOKING_RECIPE).unlockedBy("has_ingredient", has(RankineItems.TOFU.get())).save(consumer, "rankine:cooked_tofu_smoking");
