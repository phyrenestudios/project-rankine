...
public class RankineRecipesProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RankineItems.ALNICO_ELECTROMAGNET.get(), 1).pattern("WBW").pattern("WMW").define('W', RankineItems.ALLOY_WIRE.get()).define('B', RankineItems.LEAD_ACID_BATTERY.get()).define('M', RankineItems.ALNICO_MAGNET.get()).unlockedBy("has_ingredient", has(RankineItems.ALNICO_MAGNET.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RankineItems.SIMPLE_ELECTROMAGNET.get(), 1).pattern("WBW").pattern("WMW").define('W', RankineItems.ALLOY_WIRE.get()).define('B', RankineItems.SILVER_ZINC_BATTERY.get()).define('M', RankineItems.SIMPLE_MAGNET.get()).unlockedBy("has_ingredient", has(RankineItems.SIMPLE_MAGNET.get())).save(consumer);
