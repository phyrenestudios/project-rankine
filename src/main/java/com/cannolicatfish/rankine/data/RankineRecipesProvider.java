...
public class RankineRecipesProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(Blocks.TORCH, 2).pattern("C").pattern("S").define('C', RankineTags.Items.SULFUR).define('S', Tags.Items.RODS_WOODEN).unlockedBy("has_ingredient", has(RankineTags.Items.SULFUR)).group("torch").save(consumer, "rankine:torch_from_sulfur");
