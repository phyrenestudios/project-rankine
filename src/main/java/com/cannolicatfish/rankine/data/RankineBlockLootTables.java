...
/*
        ...
        for (String x : RankineLists.STONESSS) {
            for (String s : Arrays.asList(x, "polished_" + x, x + "_bricks")) {
                ...
                //createBlockLootTable(getBlock(s+"_slab"), BlockLootTables::droppingSlab);
                createBlockLootTable(getBlock(s+"_stairs"));
                createBlockLootTable(getBlock(s+"_wall"));
                //createBlockLootTable(getBlock(s+"_vertical_slab"), BlockLootTables::droppingSlab);
                createBlockLootTable(getBlock(s+"_button"));
                createBlockLootTable(getBlock(s+"_pressure_plate"));
            }
        }
        //ELEMENT BLOCKS
