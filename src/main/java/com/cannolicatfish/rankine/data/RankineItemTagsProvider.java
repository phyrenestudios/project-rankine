...
public class RankineItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(RankineTags.Items.CLAY_BALLS).add(RankineItems.FIRE_CLAY_BALL.get(), Items.CLAY_BALL, RankineItems.KAOLINITE.get());
