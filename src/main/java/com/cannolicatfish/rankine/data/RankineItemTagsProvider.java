...
public class RankineItemTagsProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        getOrCreateBuilder(RankineTags.Items.NUGGETS_NETHERITE).add(RankineItems.NETHERITE_NUGGET.get());
        getOrCreateBuilder(RankineTags.Items.NUGGETS_ENDOSITUM).add(RankineItems.ENDOSITUM_NUGGET.get());
        ...
        getOrCreateBuilder(RankineTags.Items.OSMIRIDIUM_TOOLS).add(RankineItems.OSMIRIDIUM_AXE.get(),RankineItems.OSMIRIDIUM_PICKAXE.get(),RankineItems.OSMIRIDIUM_HOE.get(),RankineItems.OSMIRIDIUM_SHOVEL.get(),RankineItems.OSMIRIDIUM_SWORD.get(),RankineItems.OSMIRIDIUM_HAMMER.get(),RankineItems.OSMIRIDIUM_SPEAR.get());
        ...
        getOrCreateBuilder(RankineTags.Items.HAMMERS).add(RankineItems.WOODEN_MALLET.get(),RankineItems.STONE_MALLET.get(),RankineItems.PEWTER_HAMMER.get(),RankineItems.ALLOY_HAMMER.get(),RankineItems.BRONZE_HAMMER.get(),RankineItems.INVAR_HAMMER.get(),RankineItems.STEEL_HAMMER.get(),RankineItems.STAINLESS_STEEL_HAMMER.get(),RankineItems.NICKEL_SUPERALLOY_HAMMER.get(),RankineItems.COBALT_SUPERALLOY_HAMMER.get(),RankineItems.TUNGSTEN_HEAVY_ALLOY_HAMMER.get(),RankineItems.ROSE_GOLD_HAMMER.get(),RankineItems.BLUE_GOLD_HAMMER.get(),RankineItems.GREEN_GOLD_HAMMER.get(),RankineItems.WHITE_GOLD_HAMMER.get(),RankineItems.PURPLE_GOLD_HAMMER.get(),RankineItems.BLACK_GOLD_HAMMER.get(),RankineItems.AMALGAM_HAMMER.get(),RankineItems.ENDER_AMALGAM_HAMMER.get());
        ...
        getOrCreateBuilder(RankineTags.Items.BLUNDERBUSSES).add(RankineItems.PEWTER_BLUNDERBUSS.get(),RankineItems.ALLOY_BLUNDERBUSS.get(),RankineItems.BRONZE_BLUNDERBUSS.get(),RankineItems.INVAR_BLUNDERBUSS.get(),RankineItems.STEEL_BLUNDERBUSS.get(),RankineItems.STAINLESS_STEEL_BLUNDERBUSS.get(),RankineItems.NICKEL_SUPERALLOY_BLUNDERBUSS.get(),RankineItems.COBALT_SUPERALLOY_BLUNDERBUSS.get(),RankineItems.TUNGSTEN_HEAVY_ALLOY_BLUNDERBUSS.get(),RankineItems.ROSE_GOLD_BLUNDERBUSS.get(),RankineItems.BLUE_GOLD_BLUNDERBUSS.get(),RankineItems.GREEN_GOLD_BLUNDERBUSS.get(),RankineItems.WHITE_GOLD_BLUNDERBUSS.get(),RankineItems.PURPLE_GOLD_BLUNDERBUSS.get(),RankineItems.BLACK_GOLD_BLUNDERBUSS.get(),RankineItems.AMALGAM_BLUNDERBUSS.get(),RankineItems.ENDER_AMALGAM_BLUNDERBUSS.get());
        ...
        getOrCreateBuilder(RankineTags.Items.SLUICING_TOOLS).addTags(RankineTags.Items.GOLD_PANS,RankineTags.Items.HAMMERS);
        ...
        for (Block blk : RankineLists.WALL_MUSHROOMS) {
            getOrCreateBuilder(Tags.Items.MUSHROOMS).add(blk.asItem());
        }
        ...
        getOrCreateBuilder(RankineTags.Items.ELECTROMAGNETS).add(RankineItems.SIMPLE_ELECTROMAGNET.get(),RankineItems.ALNICO_ELECTROMAGNET.get(),RankineItems.RARE_EARTH_ELECTROMAGNET.get());
        ...
        getOrCreateBuilder(RankineTags.Items.CRUDE_TOOLS).addTags(RankineTags.Items.WOODEN_TOOLS,RankineTags.Items.STONE_TOOLS,RankineTags.Items.IRON_TOOLS,RankineTags.Items.GOLDEN_TOOLS,RankineTags.Items.COLORED_GOLD_TOOLS,RankineTags.Items.FLINT_TOOLS,RankineTags.Items.PEWTER_TOOLS,RankineTags.Items.BRONZE_TOOLS,RankineTags.Items.INVAR_TOOLS,RankineTags.Items.OSMIRIDIUM_TOOLS,RankineTags.Items.AMALGAM_TOOLS,RankineTags.Items.ALLOY_TOOLS);
        getOrCreateBuilder(RankineTags.Items.TREE_CHOPPERS).add(RankineItems.PEWTER_AXE.get(),RankineItems.ALLOY_AXE.get(),RankineItems.BRONZE_AXE.get(),RankineItems.INVAR_AXE.get(),RankineItems.STEEL_AXE.get(),RankineItems.STAINLESS_STEEL_AXE.get(),RankineItems.NICKEL_SUPERALLOY_AXE.get(),RankineItems.COBALT_SUPERALLOY_AXE.get(),RankineItems.TUNGSTEN_HEAVY_ALLOY_AXE.get(),RankineItems.ROSE_GOLD_AXE.get(),RankineItems.BLUE_GOLD_AXE.get(),RankineItems.GREEN_GOLD_AXE.get(),RankineItems.WHITE_GOLD_AXE.get(),RankineItems.PURPLE_GOLD_AXE.get(),RankineItems.BLACK_GOLD_AXE.get(),RankineItems.AMALGAM_AXE.get(),RankineItems.ENDER_AMALGAM_AXE.get(),RankineItems.OSMIRIDIUM_AXE.get(),RankineItems.TITANIUM_ALLOY_AXE.get());
        getOrCreateBuilder(RankineTags.Items.SILICON_DIOXIDE_BLOCKS).addTags(RankineTags.Items.STONES_QUARTZITE,RankineTags.Items.CONSTRUCTION_SAND,Tags.Items.STORAGE_BLOCKS_QUARTZ);
