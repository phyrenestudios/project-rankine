...
public class RankineItemTagsProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        getOrCreateBuilder(RankineTags.Items.KNIVES).add(RankineItems.FLINT_KNIFE.get(),RankineItems.PEWTER_KNIFE.get(),RankineItems.BRONZE_KNIFE.get(),RankineItems.METAL_KNIFE.get());
