...
public class RankineItemTagsProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        //MINECRAFT
        getOrCreateBuilder(ItemTags.ARROWS).add(RankineItems.THORIUM_ARROW.get(),RankineItems.MAGNESIUM_ARROW.get(),RankineItems.ALLOY_ARROW.get());
        ...
        getOrCreateBuilder(RankineTags.Items.PEWTER_TOOLS).add(RankineItems.PEWTER_AXE.get(),RankineItems.PEWTER_PICKAXE.get(),RankineItems.PEWTER_HOE.get(),RankineItems.PEWTER_SHOVEL.get(),RankineItems.PEWTER_SWORD.get(),RankineItems.PEWTER_HAMMER.get(),RankineItems.PEWTER_SPEAR.get());
        ...
        getOrCreateBuilder(RankineTags.Items.CROWBARS).add(RankineItems.STEEL_CROWBAR.get(),RankineItems.TITANIUM_CROWBAR.get());
        getOrCreateBuilder(RankineTags.Items.KNIVES).add(RankineItems.FLINT_KNIFE.get(),RankineItems.METAL_KNIFE.get());
        ...
        getOrCreateBuilder(Tags.Items.GLASS).add(RankineItems.ETCHED_GLASS0.get()).add(RankineItems.ETCHED_GLASS1.get()).add(RankineItems.ETCHED_GLASS2.get());
