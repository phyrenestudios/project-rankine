...
public class RankineItemTagsProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        getOrCreateBuilder(RankineTags.Items.AXES).add(RankineItems.FLINT_AXE.get(),RankineItems.PEWTER_AXE.get(),RankineItems.ALLOY_AXE.get(),RankineItems.BRONZE_AXE.get(),RankineItems.INVAR_AXE.get(),RankineItems.STEEL_AXE.get(),RankineItems.STAINLESS_STEEL_AXE.get(),RankineItems.NICKEL_SUPERALLOY_AXE.get(),RankineItems.COBALT_SUPERALLOY_AXE.get(),RankineItems.TUNGSTEN_HEAVY_ALLOY_AXE.get(),RankineItems.ROSE_GOLD_AXE.get(),RankineItems.BLUE_GOLD_AXE.get(),RankineItems.GREEN_GOLD_AXE.get(),RankineItems.WHITE_GOLD_AXE.get(),RankineItems.PURPLE_GOLD_AXE.get(),RankineItems.BLACK_GOLD_AXE.get(),RankineItems.AMALGAM_AXE.get(),RankineItems.ENDER_AMALGAM_AXE.get(),RankineItems.TITANIUM_ALLOY_AXE.get(),RankineItems.NIOBIUM_ALLOY_AXE.get(),RankineItems.ZIRCONIUM_ALLOY_AXE.get(),RankineItems.OSMIRIDIUM_AXE.get());
        ...
        getOrCreateBuilder(RankineTags.Items.SWORDS).add(RankineItems.PEWTER_SWORD.get(),RankineItems.ALLOY_SWORD.get(),RankineItems.BRONZE_SWORD.get(),RankineItems.INVAR_SWORD.get(),RankineItems.STEEL_SWORD.get(),RankineItems.STAINLESS_STEEL_SWORD.get(),RankineItems.NICKEL_SUPERALLOY_SWORD.get(),RankineItems.COBALT_SUPERALLOY_SWORD.get(),RankineItems.TUNGSTEN_HEAVY_ALLOY_SWORD.get(),RankineItems.ROSE_GOLD_SWORD.get(),RankineItems.BLUE_GOLD_SWORD.get(),RankineItems.GREEN_GOLD_SWORD.get(),RankineItems.WHITE_GOLD_SWORD.get(),RankineItems.PURPLE_GOLD_SWORD.get(),RankineItems.BLACK_GOLD_SWORD.get(),RankineItems.AMALGAM_SWORD.get(),RankineItems.ENDER_AMALGAM_SWORD.get(),RankineItems.TITANIUM_ALLOY_SWORD.get(),RankineItems.NIOBIUM_ALLOY_SWORD.get(),RankineItems.ZIRCONIUM_ALLOY_SWORD.get(),RankineItems.OSMIRIDIUM_SWORD.get());
        ...
        getOrCreateBuilder(RankineTags.Items.FISHING_RODS).add(Items.FISHING_ROD,RankineItems.ALLOY_SURF_ROD.get());
        ...
        getOrCreateBuilder(RankineTags.Items.NUTS_COCONUT).add(RankineItems.COCONUT.get());
        getOrCreateBuilder(RankineTags.Items.NUTS_WALNUT).add(RankineItems.BLACK_WALNUT.get());
        ...
        getOrCreateBuilder(RankineTags.Items.FLUXES).addTags(RankineTags.Items.STONES_LIMESTONE,RankineTags.Items.STONES_DOLOMITE).add(RankineItems.DOLOMITE.get(),RankineItems.CALCITE.get(),RankineItems.QUICKLIME.get());
        getOrCreateBuilder(RankineTags.Items.GLASS_INPUTS).addTags(RankineTags.Items.SILT,Tags.Items.SAND,Tags.Items.GEMS_QUARTZ);
