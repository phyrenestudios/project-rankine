...
public class RankineBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(RankineBlocks.MATERIAL_TESTING_BENCH.get(), models().orientable(RankineBlocks.MATERIAL_TESTING_BENCH.get().getRegistryName().getPath(), getRSL("material_testing_table_side"), getRSL("material_testing_table_front"), getRSL("material_testing_table_top")));
