...
public class RankineBlockStateProvider extends BlockStateProvider {
    ...
    public void verticalSlabBlock(RankineVerticalSlabBlock BLK, ResourceLocation all) {
        ...
        ModelFile innerSlab = models().withExistingParent(BLK.getRegistryName().getPath()+"_inner", mcLoc("block/block"))
                ...
                .face(Direction.NORTH).uvs(0.0f,0.0f,8.0f,16.0f).texture("#all").cullface(Direction.NORTH).end()
                ...
                .face(Direction.WEST).uvs(0.0f,0.0f,8.0f,16.0f).texture("#all").cullface(Direction.WEST).end()
                .face(Direction.UP).uvs(0.0f,0.0f,16.0f,16.0f).texture("#all").end()
                .face(Direction.DOWN).uvs(0.0f,0.0f,16.0f,16.0f).texture("#all").end()
                .end();
