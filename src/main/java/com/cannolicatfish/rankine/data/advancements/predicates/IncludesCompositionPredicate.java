...
public class IncludesCompositionPredicate extends ItemPredicate {
    ...
    public IncludesCompositionPredicate(@Nullable TagKey<Item> tagIn, @Nullable Set<Item> itemsIn, String composition) {
        this.tag = tagIn;
        this.items = itemsIn;
    ...
    public boolean matches(ItemStack stack) {
        if (stack.getItem() instanceof IAlloyItem) {
            if (this == ANY) {
                ...
                return IAlloyItem.getAlloyComposition(stack).contains(this.composition);
    ...
    public static ItemPredicate fromJson(@Nullable JsonElement p_45052_) {
        if (p_45052_ != null && !p_45052_.isJsonNull()) {
            ...
            if (jsonobject.has("data")) {
                ...
                return new IncludesCompositionPredicate(tagkey, set, composition);
            }
        } else {
            return ANY;
        }
    ...
    public static class Builder {
        ...
        public static IncludesCompositionPredicate.Builder item() {
            return new IncludesCompositionPredicate.Builder();
        }

        public IncludesCompositionPredicate.Builder of(ItemLike... p_151446_) {
            this.items = Stream.of(p_151446_).map(ItemLike::asItem).collect(ImmutableSet.toImmutableSet());
            return this;
        }

        public IncludesCompositionPredicate.Builder of(TagKey<Item> p_204146_) {
            this.tag = p_204146_;
            return this;
        }

        public IncludesCompositionPredicate.Builder withComposition(String p_151444_) {
