package com.cannolicatfish.rankine.data.advancements.predicates;
...
public class AlloyEnchantabilityPredicate extends ItemPredicate {
    ...
    public AlloyEnchantabilityPredicate(@Nullable TagKey<Item> tagIn, @Nullable Set<Item> itemsIn, MinMaxBounds.Ints level) {
        this.tag = tagIn;
        this.items = itemsIn;
        this.level = level;
    }
    ...
    public boolean matches(ItemStack stack) {
        if (stack.getItem() instanceof IAlloyTool) {
            if (this == ANY) {
                ...
                return this.level.matches(((IAlloyTool) stack.getItem()).getAlloyEnchantability(stack));
    ...
    public JsonElement serializeToJson() {
        if (this == ANY) {
            ...
            jsonobject.addProperty("type", "rankine:enchantability_check");
    ...
    public static class Builder {
        ...
        public static AlloyEnchantabilityPredicate.Builder item() {
            return new AlloyEnchantabilityPredicate.Builder();
        }

        public AlloyEnchantabilityPredicate.Builder of(ItemLike... p_151446_) {
            this.items = Stream.of(p_151446_).map(ItemLike::asItem).collect(ImmutableSet.toImmutableSet());
            return this;
        }

        public AlloyEnchantabilityPredicate.Builder of(TagKey<Item> p_204146_) {
            this.tag = p_204146_;
            return this;
        }

        public AlloyEnchantabilityPredicate.Builder withLevel(MinMaxBounds.Ints p_151444_) {
            this.level = p_151444_;
            return this;
        }

        public AlloyEnchantabilityPredicate build() {
            return new AlloyEnchantabilityPredicate(this.tag, this.items, this.level);
        }
    }
}
