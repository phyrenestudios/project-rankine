...
public class RankineLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("rankine.advancements.story.get_flint_tools.description", "Construct a Flint Pickaxe to begin mining");
        add("rankine.advancements.story.get_stone_hammer.title", "Timing is Everything");
        add("rankine.advancements.story.get_stone_hammer.description", "Construct a Stone Hammer to crush blocks for different products); including those to make cobblestone");
        ...
        add("rankine.advancements.story.make_template_table.title", "Knowledge is Pewter");
        ...
        add("rankine.advancements.story.get_bronze_tools.title", "Bronze Age");
        add("rankine.advancements.story.get_bronze_tools.description", "Make a Bronze); Rose Gold); or Pewter Hammer to begin crushing ores");
