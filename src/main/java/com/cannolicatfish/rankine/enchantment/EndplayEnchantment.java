...
public class EndplayEnchantment extends Enchantment {
    public EndplayEnchantment(Rarity p_i46721_1_, EquipmentSlot... p_i46721_2_) {
    ...
    public boolean canEnchant(ItemStack stack) {
        ...
        return RankineEnchantmentTypes.ENDER_AMALGAM_BLUNDERBUSS.canEnchant(stack.getItem());
    }
