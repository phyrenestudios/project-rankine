...
public class WoodBucket extends BucketItem {
    ...
    public WoodBucket(Supplier<? extends Fluid> supplier, Properties builder) {
        super(supplier, builder);
        this.containedBlock = supplier.get();
        this.getContainerItem(new ItemStack(ModItems.WOOD_BUCKET));

    }

    @Override
    public ItemStack getContainerItem(ItemStack itemStack) {
        return new ItemStack(ModItems.WOOD_BUCKET);
    }
...
//        System.out.println(fullBucket);
        ...
        {
            //player.playSound();
            fullBucket = ModItems.MILK_WOOD_BUCKET;
        }
    ...
    private Item getWoodBucket(Fluid fluid)
    {
        if (fluid == Fluids.WATER)
        {
            return ModItems.WATER_WOOD_BUCKET;
        }
        return ModItems.WOOD_BUCKET;
    }
}
