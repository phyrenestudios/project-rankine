...
public class HasteTotemItem extends Item{
    public HasteTotemItem(Properties properties) {
        super(properties);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("item.rankine.totem_of_hastening.tooltip").mergeStyle(TextFormatting.GRAY, TextFormatting.ITALIC));
    }
