    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player != null && b.isPresent()) {
            ...
            if (!worldIn.isClientSide()) {
                ...
                player.displayClientMessage(new TranslatableComponent("item.rankine.ore_detector.message", new TranslatableComponent(ORE.getBlock().getDescriptionId()).getString(), "Unknown", b.get().getX(), b.get().getY(), b.get().getZ()), false);
