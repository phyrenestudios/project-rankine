...
public class ItemCrowbar extends ToolItem {
    ...
    public ItemCrowbar(float attackDamageIn, float attackSpeedIn, IItemTier tier, Properties p_i48512_5_) {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        if (enchantment == ModEnchantments.SWING || enchantment == Enchantments.MENDING || enchantment == Enchantments.VANISHING_CURSE)
        {
            return true;
        }
        else
